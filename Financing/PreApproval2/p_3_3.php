  ...
  <td style="background-color: #ffffff; padding-bottom:20px;" class="vb-outer" align="center" bgcolor="#FFFFFF" valign="top">
    ...
    <div class="oldwebkit" style="max-width: 640px;">
      <table style="border-collapse: separate;border-spacing: 0px;width: 640px;max-width: 640px;background-color: #fff;"
             class="vb-row fullpad" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="640" align="center">
        <tbody>

          <tr valign="top" align="center">
            <td class="mobile-row" style="font-size: 0;" align="left" valign="top">
                  ...
                  <tbody>
                    <tr>
                      <td class="" align="left" valign="top" width="100%">
                        ...
                        <img src="image_library/org_1/2688/eMail_Postcard-Finance_CC-Welcome_v2_11.jpg" style="border: 0px;vertical-align: top;width: 100%;height: auto;" 
                  ...
                  <tbody>
                    <tr>
                      <td class="" style="font-size: 20px; font-family: 'Montserrat', Helvetica, sans-serif; font-weight:600; color: #006bb0; text-align: left; padding-bottom:5px;">
                        EXCLUSIVE PROMOTIONS</td>
                    </tr>
                    <tr>
                      <td style="text-align: left; font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #737373;" class="" align="left">
                          Get exclusive access to accountholder special financing offers and future discounts.
                      </td>
                    </tr>
                  </tbody>
                </table>
