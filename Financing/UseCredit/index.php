		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $ttl = "Great News! You Have ##otb## Available on your Adorama Credit Card Account for Free Overnight Shipping Deals!"; ?>
					
					<?php include_once("Financing/blocks/header.php"); ?>
						
					<?php include_once("Financing/UseCredit/p_1.php"); ?>
					
					<?php include_once("Financing/UseCredit/p_2.php"); ?>		
					
					<?php include_once("Financing/UseCredit/p_5.php"); ?>

					<?php include_once("Financing/UseCredit/p_4.php"); ?>
