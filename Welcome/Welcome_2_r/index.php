          ...
          <td align="center" bgcolor="#e3e3e3">
            <table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
              <tbody>
                ...
                <?php //include_once("Welcome_2/blocks/send_button.php"); ?>

                <?php $utm = "EmailWelcome2"; ?>

                <?php $ttl = "From tutorials to gear rentals, photo prints to pro gear, discover everything we have to offer!"; ?>

                <?php include_once("Welcome/blocks/header.php"); ?>

                <?php include_once("Welcome/Welcome_2_r/p_1.php"); ?>
                <?php include_once("Welcome/Welcome_2_r/p_2.php"); ?>
                <?php include_once("Welcome/Welcome_2_r/p_3.php"); ?>
                <?php include_once("Welcome/Welcome_2_r/p_4.php"); ?>
                <?php include_once("Welcome/Welcome_2_r/p_5.php"); ?>
                <?php include_once("Welcome/Welcome_2_r/p_6.php"); ?>
                <?php include_once("Welcome/Welcome_2_r/p_7.php"); ?>
                <?php include_once("Welcome/Welcome_2_r/p_8.php"); ?>
                <?php include_once("Welcome/Welcome_2_r/p_9.php"); ?>
