              ...
              <tbody>
                <tr>
                  <td class="copy" style="font-size: 18px; font-family: Arial, Helvetica, sans-serif; color: #006ab2; 
                                          text-transform: uppercase; text-align: center; line-height: normal" valign="middle"><br />
                    <strong>Experience Adorama Value</strong><br /> &nbsp;
                  </td>
                </tr>
              </tbody>
            </table>
...
<tr>
  <td align="center" bgcolor="#ffffff" style="padding-top: 12px; padding-bottom: 12px">
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%">
      <tbody>
        <tr>
          <td align="center" class="split" valign="middle">
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="" width="33.3%">
              <tbody>
                ...
                <tr>
                  <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #2B3B48; text-align: center; line-height: normal" valign="middle">Get you gear fast with<br /> same day shipping on most<br /> order placed before 8 PM!*<br /> &nbsp;
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <td align="center" class="split" valign="middle">
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="" width="33.3%">
              <tbody>
                ...
                <tr>
                  <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #2B3B48; text-align: center; line-height: normal" valign="middle">Try before you buy!<br /> Test drive select pro gear<br /> for up to a week!<br /> &nbsp;
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <td align="center" class="split" valign="middle">
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="" width="33.3%">
              <tbody>
                ...
                <tr>
                  <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #2B3B48; text-align: center; line-height: normal" valign="middle">Become an Adorama VIP<br /> and discover a world of<br /> unique value, deals &amp; perks!<br /> &nbsp;
                  </td>
                </tr>
              </tbody>
            </table>
