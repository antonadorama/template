		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailWelcomeIV"; ?>
					
					<?php $ttl = "Shop this Month's Best Deals on TV's, Computers, Tablets, Cameras, Lenses and More!"; ?>
					
					<?php include_once("Welcome/blocks/header.php"); ?>
					
					<!-- Intro --->
					<?php include_once("Welcome/Welcome_4/p_1.php"); ?>
					
						<?php include_once("Welcome/Welcome_4/p_2.php"); ?>
					
						<?php include_once("Welcome/Welcome_4/p_3.php"); ?>

					<?php include_once("Welcome/Welcome_4/bestsellers.php"); ?>
					
					<?php include_once("Welcome/Welcome_4/4products_block_cb.php"); ?>
