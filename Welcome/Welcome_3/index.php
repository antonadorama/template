		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailWelcome3"; ?>
					
					<?php $ttl = "Get Free Shipping, See Product Reviews and Get Personalized Concierge Service!"; ?>
					
					<?php include_once("Welcome/blocks/header.php"); ?>
					
					<!-- Intro --->
					<?php include_once("Welcome/Welcome_3/p_1.php"); ?>
					<?php include_once("Welcome/Welcome_3/p_2.php"); ?>
					<?php include_once("Welcome/Welcome_3/p_3.php"); ?>
					<?php include_once("Welcome/Welcome_3/p_4.php"); ?>
					<?php include_once("Welcome/Welcome_3/p_5.php"); ?>

					<?php include_once("Welcome/Welcome_3/4products_block_cb.php"); ?>
