              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="http://www.adorama.com/pages/FlexShopper?category=1000061&emailprice=t&utm_source=slgt&refby=slgt&utm_medium=email&guid=##GUID##&utm_term=Shop&utm_content=Header&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="D_FlexShopper">
                    <img src="image_library/org_1/2248/adorama_welcome3_05.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Flexshopper Financing!" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
