		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailWelcomeVI"; ?>
					
					<?php $ttl = "Yes, We've Overstocked our Warehouse & That Means Huge Deals in Nearly Every Category!"; ?>
					
					<?php include_once("Welcome/blocks/header.php"); ?>
					
					<!-- Intro --->
					<?php include_once("Welcome/Welcome_6/p_1.php"); ?>
					
						<?php include_once("Welcome/Welcome_6/p_2.php"); ?>
					
						<?php include_once("Welcome/Welcome_6/p_3.php"); ?>

					<?php include_once("Welcome/Welcome_6/bestsellers.php"); ?>
					
					<?php include_once("Welcome/Welcome_6/4products_block_cb.php"); ?>
