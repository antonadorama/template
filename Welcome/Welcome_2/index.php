		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<!-- Intro --->
					<?php include_once("Welcome/Welcome_2/3_1.php"); ?>
					
					<!-- Devider --->
					<?php include("Welcome/Welcome_2/devider.php"); ?>
					
					
					<!-- Learn More--->					
				  <?php include_once("Welcome/Welcome_2/3_2.php"); ?>
					<!-- Main Bullets--->
			    <?php include_once("Welcome/Welcome_2/3_3.php"); ?>
					...
					<!-- Products Header--->
					<?php include_once("Welcome/Welcome_2/3_7.php"); ?>
					<!-- Devider --->
					<?php include("Welcome/Welcome_2/devider.php"); ?>
					<!-- Featured Products --->

					<?php include_once("Welcome/Welcome_2/4products_block_cb.php"); ?>
