		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email-VIPWelcomeII"; ?>
					
					<?php $ttl = "Go Beyond VIP! Join VIP360 and Get Free 2 Day Delivery, Drops and Spills Warranty & Extended 60 Day Returns!"; ?>
					
					<?php include_once("Welcome/blocks/header.php"); ?>
					
					<!-- Intro --->
					<?php include_once("Welcome/Welcome_II_VIP/p_1.php"); ?>
					
					<?php include_once("Welcome/Welcome_II_VIP/bestsellers.php"); ?>
					
					<?php include_once("Welcome/Welcome_II_VIP/4products_block_cb.php"); ?>
