		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailWelcomeV"; ?>
					
					<?php $ttl = "Grab Exclusive Limited-Time Rebates on Hundreds of Items Before They Expire!"; ?>
					
					<?php include_once("Welcome/blocks/header.php"); ?>
					
					<!-- Intro --->
					<?php include_once("Welcome/Welcome_5/p_1.php"); ?>
					
						<?php include_once("Welcome/Welcome_5/p_2.php"); ?>
					
						<?php include_once("Welcome/Welcome_5/p_3.php"); ?>

					<?php include_once("Welcome/Welcome_5/bestsellers.php"); ?>
					
					<?php include_once("Welcome/Welcome_5/4products_block_cb.php"); ?>
