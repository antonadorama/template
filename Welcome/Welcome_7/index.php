		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailWelcomeVII"; ?>
					
					<?php $ttl = "Plus, any High-Quality Refurbished Equipment sold by Adorama includes 90-day Return-to-Manufacturer Warranties!"; ?>
					
					<?php include_once("Welcome/blocks/header.php"); ?>
					
					<!-- Intro --->
					<?php include_once("Welcome/Welcome_7/p_1.php"); ?>
					
						<?php include_once("Welcome/Welcome_7/p_2.php"); ?>
					
						<?php include_once("Welcome/Welcome_7/p_3.php"); ?>

					<?php include_once("Welcome/Welcome_7/bestsellers.php"); ?>
					
					<?php include_once("Welcome/Welcome_7/4products_block_cb.php"); ?>
