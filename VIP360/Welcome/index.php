		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_VIP360EmailWelcome_VIPWlc"; ?>
					
					<?php $ttl = "TTL"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("VIP360/Welcome/p_1.php"); ?>
          <?php include_once("VIP360/Welcome/p_2.php"); ?>
          <?php include_once("VIP360/Welcome/p_3.php"); ?> 
