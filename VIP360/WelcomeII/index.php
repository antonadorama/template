		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_VIP360EmailWelcomeII_VIPWII"; ?>
					
					<?php $ttl = "Get to know your VIP360 member perks!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("VIP360/WelcomeII/p_1.php"); ?>  
          <?php //include_once("VIP360/WelcomeII/p_2.php"); ?>
          <?php include_once("VIP360/WelcomeII/p_2_white.php"); ?>  
