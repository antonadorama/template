		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_SuperSale_Ext_012718"; ?>
					
					<?php $ttl = "We have extended this great offer. Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/SuperSaleExt/p_1.php"); ?>
					
					<?php include_once("Other/SuperSaleExt/p_3.php"); ?>

					<?php include_once("Other/SuperSaleExt/p_2.php"); ?>
