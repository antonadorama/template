...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_FlashSaleApple_091119"; ?>
					
					<?php $ttl = "Save BIG on Apple products during our limited-time Flash Sale"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>   

          <?php //include_once("Other/FlashSale911/p_0.php"); ?>          
          
          <?php //include_once("Other/FlashSale911/p_1.php"); ?>
          <?php //include_once("Other/FlashSale911/p_1_lc.php"); ?>
          <?php //include_once("Other/FlashSale911/p_1_ext.php"); ?>

               
          
          
          <?php //include_once("Other/FlashSale911/p_1_canon.php"); ?>
          <?php //include_once("Other/FlashSale911/p_1_nikon.php"); ?>
          <?php //include_once("Other/FlashSale911/p_1_sony.php"); ?>
          <?php //include_once("Other/FlashSale911/p_1_panasonic.php"); ?>
          <?php //include_once("Other/FlashSale911/p_1_fujifilm.php"); ?>
          <?php //include_once("Other/FlashSale911/p_1_olympus.php"); ?>
          <?php include_once("Other/FlashSale911/p_1_apple.php"); ?>
          
         
          <?php include_once("Other/FlashSale911/p_2.php"); ?>
          <?php include_once("Other/FlashSale911/p_3.php"); ?>
          <?php include_once("Other/FlashSale911/p_4.php"); ?>    
