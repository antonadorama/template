...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_ExpiringAprilRebates_042919"; ?>
					
					<?php $ttl = "Save big before these instant rebates expire!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/ExpiringAprilRebates/p_1.php"); ?>
          <?php include_once("Other/ExpiringAprilRebates/p_2.php"); ?>

          <?php include_once("Other/ExpiringAprilRebates/p_3.php"); ?>
          <?php include_once("Other/ExpiringAprilRebates/p_4.php"); ?>
          <?php include_once("Other/ExpiringAprilRebates/p_5.php"); ?>
          <?php include_once("Other/ExpiringAprilRebates/p_6.php"); ?>
          <?php include_once("Other/ExpiringAprilRebates/p_7.php"); ?>
          <?php include_once("Other/ExpiringAprilRebates/p_8.php"); ?>        
