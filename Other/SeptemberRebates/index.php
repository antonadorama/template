		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_SeptemberRebatesApple_090618"; ?>
					
					<?php $ttl = "Shop now for the latest Apple rebates!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php //include_once("Other/SeptemberRebates/p_1.php"); ?> 
          
          <?php //include_once("Other/SeptemberRebates/p_1_canon.php"); ?> 
          <?php //include_once("Other/SeptemberRebates/p_1_nikon.php"); ?> 
          <?php //include_once("Other/SeptemberRebates/p_1_sony.php"); ?>
          <?php include_once("Other/SeptemberRebates/p_1_apple.php"); ?> 
          
          <?php include_once("Other/SeptemberRebates/p_2.php"); ?>

          <?php include_once("Other/SeptemberRebates/p_3.php"); ?>
          <?php include_once("Other/SeptemberRebates/p_4.php"); ?>
          <?php include_once("Other/SeptemberRebates/p_5.php"); ?>
          <?php include_once("Other/SeptemberRebates/p_6.php"); ?>
          <?php include_once("Other/SeptemberRebates/p_7.php"); ?>
          <?php include_once("Other/SeptemberRebates/p_8.php"); ?>
          
          <?php include_once("Other/SeptemberRebates/p_9.php"); ?>
          <?php include_once("Other/SeptemberRebates/p_10.php"); ?>
