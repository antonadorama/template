		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_OutletSale_Default_010618"; ?>
					
					<?php $ttl = "These Hot outlet deals will warm you up for sure..."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					

					<?php include_once("Other/OutletSale/Default/p_1.php"); ?>
					<?php include_once("Other/OutletSale/Default/p_2.php"); ?>
