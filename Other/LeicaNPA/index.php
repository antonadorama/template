		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_LeicaNPA_112117"; ?>
					
					<?php $ttl = "Meet Leica CL, the world’s most tactile APS-C System Camera & the New Leica ELMARIT-TL Pancake Lens"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					
					<?php include_once("Other/LeicaNPA/p_1.php"); ?>
					
					<?php include_once("Other/LeicaNPA/p_2.php"); ?>
					
					
					<?php include_once("Other/LeicaNPA/p_3.php"); ?>
					
					
					<?php include_once("Other/LeicaNPA/p_4.php"); ?>
					
					<?php include_once("Other/LeicaNPA/p_5.php"); ?>
					
					<?php include_once("Other/LeicaNPA/p_6.php"); ?>
					
					
					<?php include_once("Other/LeicaNPA/p_7.php"); ?>
					
					<?php include_once("Other/LeicaNPA/p_8.php"); ?>
