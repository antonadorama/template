		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Refurbished_090917"; ?>
					
					<?php $ttl = "+ Don’t miss our hottest prices on open box, overstock and used clearance items"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
				
					<?php include_once("Other/Refurb090917/p_1.php"); ?>
					<?php include_once("Other/Refurb090917/p_2.php"); ?>
					<?php include_once("Other/Refurb090917/p_3.php"); ?>
					<?php include_once("Other/Refurb090917/p_4.php"); ?>
