		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_FlashpointSnapshot_082818"; ?>
					
					<?php $ttl = "Shop our Flashpoint SALE now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/FlashpointSnapshot/p_1.php"); ?>
          <?php include_once("Other/FlashpointSnapshot/p_2.php"); ?>
          <?php include_once("Other/FlashpointSnapshot/p_3.php"); ?>
          <?php include_once("Other/FlashpointSnapshot/p_4.php"); ?>
          <?php include_once("Other/FlashpointSnapshot/p_5.php"); ?>
          <?php include_once("Other/FlashpointSnapshot/p_6.php"); ?>
          <?php include_once("Other/FlashpointSnapshot/p_7.php"); ?>
