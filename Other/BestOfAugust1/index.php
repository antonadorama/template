		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_BestOfAugust1_082918"; ?>
					
					<?php $ttl = "Shop the newest and best of August, before they're gone."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/BestOfAugust1/p_1.php"); ?>
          <?php include_once("Other/BestOfAugust1/p_2.php"); ?>
          <?php include_once("Other/BestOfAugust1/p_3.php"); ?>
          <?php include_once("Other/BestOfAugust1/p_4.php"); ?>
          <?php include_once("Other/BestOfAugust1/p_5.php"); ?>
          <?php include_once("Other/BestOfAugust1/p_6.php"); ?>
          <?php include_once("Other/BestOfAugust1/p_7.php"); ?>
