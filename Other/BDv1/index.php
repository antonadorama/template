		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_BirthDay_ThankYou_v1"; ?>
					
					<?php $ttl = "It's our birthday, and we've got a party favor straight from our CEO's desk."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/BDv1/p_1.php"); ?>
