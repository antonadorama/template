		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_JanuaryBundlesMain_012418"; ?>
					
					<?php $ttl = "Get FREE gear when you shop top brands now"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/JanuaryBundles/p_1.php"); ?>
          <?php include_once("Other/JanuaryBundles/p_3.php"); ?>
          <?php include_once("Other/JanuaryBundles/p_2.php"); ?>
          
           <?php include_once("Other/JanuaryBundles/p_4.php"); ?> 
           <?php include_once("Other/JanuaryBundles/p_5.php"); ?>
