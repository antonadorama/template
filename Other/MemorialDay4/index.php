...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_MemorialDay4_052719"; ?>
					
					<?php $ttl = "Don't miss out on these HUGE Memorial Day weekend savings!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/MemorialDay4/p_1.php"); ?>
          <?php include_once("Other/MemorialDay4/p_2.php"); ?>
          <?php include_once("Other/MemorialDay4/p_3.php"); ?>
          <?php include_once("Other/MemorialDay4/p_8.php"); ?>
          <?php include_once("Other/MemorialDay4/p_9.php"); ?>
          <?php include_once("Other/MemorialDay4/p_4.php"); ?>
          <?php include_once("Other/MemorialDay4/p_5.php"); ?>
          <?php include_once("Other/MemorialDay4/p_6.php"); ?>
