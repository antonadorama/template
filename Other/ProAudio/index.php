		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_ProAudio_083017"; ?>
					
					<?php $ttl = "Get That Next Level Sound with Fresh Pro Audio Gear & Deals from Tascam, Sennheiser, Zoom, Rode & More..."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/ProAudio/p_1.php"); ?>
														
					<?php include_once("Other/ProAudio/p_2.php"); ?>
					
					<?php include_once("Other/ProAudio/p_3.php"); ?>
					
					<?php include_once("Other/ProAudio/p_4.php"); ?>
					
					<?php include_once("Other/ProAudio/p_5.php"); ?>
					
					<?php include_once("Other/ProAudio/p_6.php"); ?>
					
					<?php include_once("Other/ProAudio/p_7.php"); ?>
					
					<?php include_once("Other/ProAudio/p_8.php"); ?>
					
					<?php include_once("Other/ProAudio/p_9.php"); ?>
					
					<?php include_once("Other/ProAudio/p_10.php"); ?>
					
					<?php include_once("Other/ProAudio/p_11.php"); ?>					
