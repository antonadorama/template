              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/pages/usedQuote?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Trade&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="D_FP_Trade_In">
                    <img src="image_library/org_1/3132/eMail_Postcard-Trade_So17_Jan2018_v2.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
