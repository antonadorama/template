		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_AppleSale_122617"; ?>
					
					<?php $ttl = "Up To 39% OFF Macbooks, iMacs, and iPads + Fresh Apple Rebates!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
	
					<?php include_once("Other/AppleSale_122617/p_1.php"); ?>
					
					<?php include_once("Other/AppleSale_122617/p_2.php"); ?>
					
					<?php include_once("Other/AppleSale_122617/p_3.php"); ?>			
