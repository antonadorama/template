...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_AppleBackToSchoolLC_081418"; ?>
          <?php $ttl = "Back-to-School Sale on Apple products happening NOW!"; ?> 
          
					<?php include_once("Other/blocks/header.php"); ?>		 

          <?php include_once("Other/AppleBackLC/p_1.php"); ?>
          <?php include_once("Other/AppleBackLC/p_2.php"); ?>
          <?php include_once("Other/AppleBackLC/p_3.php"); ?>
          <?php include_once("Other/AppleBackLC/p_4.php"); ?>
          <?php include_once("Other/AppleBackLC/p_5.php"); ?>
          <?php include_once("Other/AppleBackLC/p_6.php"); ?>
          <?php include_once("Other/AppleBackLC/p_7.php"); ?>
          <?php include_once("Other/AppleBackLC/p_8.php"); ?>
