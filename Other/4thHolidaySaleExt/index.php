		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_4thJuly_Holiday_Sale_Ext_Canon_070717"; ?>
					
					<?php $ttl = "You can still grab up to 60% OFF + 48% OFF Nikon Deal!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php //include_once("Other/4thHolidaySaleExt/p_5_sony.php"); ?>
					
					<?php //include_once("Other/4thHolidaySaleExt/p_5_nikon.php"); ?>
					
					<?php include_once("Other/4thHolidaySaleExt/p_5_canon.php"); ?>
		
					<?php include_once("Other/4thHolidaySaleExt/p_1.php"); ?>
					
					<?php include_once("Other/4thHolidaySaleExt/p_2.php"); ?>
