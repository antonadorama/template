...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_RolandNPA_090519"; ?>
					
					<?php $ttl = "Shop the NEW Roland Synthesizers and Grooveboxes now"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>   

    
          <?php include_once("Other/RolandNPA/p_1.php"); ?>
          <?php include_once("Other/RolandNPA/p_2.php"); ?>   
          <?php include_once("Other/RolandNPA/p_3.php"); ?>   
          <?php include_once("Other/RolandNPA/p_4.php"); ?>   
          <?php include_once("Other/RolandNPA/p_5.php"); ?>     
