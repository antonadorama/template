		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_MidSummer_Sale_Canon_LC_072517"; ?>
					
					<?php $ttl = "Get up to 55% off - Hurry, the clock's ticking! Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/MidSummerCanon/p_1.php"); ?>	
					
				<?php include_once("Other/MidSummerCanon/p_2.php"); ?>	
					
					<?php include_once("Other/MidSummerLC/p_1.php"); ?>	
					
					<?php include_once("Other/MidSummerLC/p_2.php"); ?>	
					
					<?php include_once("Other/MidSummerLC/p_3.php"); ?>	
