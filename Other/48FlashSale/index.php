...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_48HoursFlashSale_061418"; ?>
          <?php $ttl = "Flash Sale Alert!"; ?>

					<?php include_once("Other/blocks/header.php"); ?>	
          
          <?php include_once("Other/48FlashSale/countdown.php"); ?>
          
					<?php include_once("Other/48FlashSale/p_1.php"); ?>
          <?php include_once("Other/48FlashSale/p_2.php"); ?>
          <?php include_once("Other/48FlashSale/p_3.php"); ?>
          <?php include_once("Other/48FlashSale/p_4.php"); ?>
          <?php //include_once("Other/48FlashSale/p_5.php"); ?>
