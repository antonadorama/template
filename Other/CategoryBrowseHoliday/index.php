		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_CategoryBrowse_110818"; ?>
					
					<?php $ttl = "We’re Gifting You Early Access to Holiday Savings on ##SECOND_LEVEL_CATEGORY##! Shop Early!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php //include_once("Other/CategoryBrowse/p_1_white.php"); ?>
          <?php include_once("Other/CategoryBrowseHoliday/browsed_yellow.php"); ?>
