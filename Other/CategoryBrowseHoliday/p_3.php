...
<tr>
  <td>
    <table id="ko_imageBlock_5" style="background-color: #e7ba3d;" class="vb-outer" bgcolor="#e7ba3d" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
        <td class="vb-outer" align="center" valign="top" style="">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #e7ba3d;" class="vb-container fullwidth" align="center" bgcolor="#e7ba3d" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td>
                      <a href="##second_level_category_url##?sel=Price-Range_-dollar-250-to-dollar-500&emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Shop&utm_content=Body&utm_campaign=<?php echo $utm;?>" 
                        ...
                        <img src="image_library/org_1/4551/Category-Browse-Email_03_yellow.png" alt="Dollar Icon" width="100%" height="auto" border="0" style="display:inline;">
                      </a>
                  </td>
                  <td>
                    <a href="##second_level_category_url##?sel=Ratings-and-Reviews_4-and-up&emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Shop&utm_content=Body&utm_campaign=<?php echo $utm;?>" 
                      ...
                      <img src="image_library/org_1/4551/Category-Browse-Email_04_yellow.png" alt="Star Icon" width="100%" height="auto" border="0" style="display:inline;">
                    </a>
                  </td>
                </tr>
              </tbody>
