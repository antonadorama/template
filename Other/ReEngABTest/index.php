...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_ReEngABTest_080118"; ?>
          <?php $ttl = "We wanted to give you something special, just for you! Take a peek!"; ?> 
          
					<?php include_once("Other/blocks/header.php"); ?>		 

          <?php include_once("Other/ReEngABTest/p_1.php"); ?>
					...
					<?php include_once("Other/ReEngABTest/finance_footer.php"); ?>
