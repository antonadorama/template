		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Profoto_FlashSale_090817"; ?>
					
					<?php $ttl = "Shop Limited Time Profoto B1 Price Drops & Get 3 FREE Gifts of Up To $1,086 with Purchase!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
				
					<?php include_once("Other/Profoto/p_1.php"); ?>					
					<?php include_once("Other/Profoto/p_2.php"); ?>
					<?php include_once("Other/Profoto/p_3.php"); ?>
					<?php include_once("Other/Profoto/p_4.php"); ?>
					<?php include_once("Other/Profoto/p_5.php"); ?>
					<?php include_once("Other/Profoto/p_6.php"); ?>
					<?php include_once("Other/Profoto/p_7.php"); ?>
