...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_FujiHotDeals_081819"; ?>
					
					<?php $ttl = "Shop Fujifilm for summer & save up to $1,000 on select X Series + more!"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>   

          <?php include_once("Other/FujiHotDeals/p_1.php"); ?>
          <?php include("Other/SummerSunday/devider.php"); ?>
          <?php include_once("Other/FujiHotDeals/p_2.php"); ?>
          <?php include("Other/SummerSunday/devider.php"); ?>
          <?php include_once("Other/FujiHotDeals/p_3.php"); ?>
          <?php include("Other/SummerSunday/devider.php"); ?>
          <?php include_once("Other/FujiHotDeals/p_4.php"); ?>
          <?php include("Other/SummerSunday/devider.php"); ?>
          <?php include_once("Other/FujiHotDeals/p_5.php"); ?>
