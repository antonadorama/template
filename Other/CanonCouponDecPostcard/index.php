		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_CanonCouponDecpostcard_122117"; ?>
					...
					<?php include_once("Other/CanonCouponDecPostcard/p_1.php"); ?>

					<?php include_once("Other/CanonCouponDecPostcard/p_2.php"); ?>
					
					<?php include_once("Other/CanonCouponDecPostcard/p_3.php"); ?>
