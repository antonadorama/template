                    ...
                    <a href="https://www.adorama.com/?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Logo&utm_content=ProAudioHeader&utm_campaign=<?php echo $utm;?>	" linkname="Logo" style="color: inherit" target="_blank">
                      <img alt="ADORAMA - More than a camera store" border="0" src="https://www.adorama.com/col/images/email/logo-x2.png" style="display:block;" width="155" />
                          ...
                          <a color="#393F42" href="https://www.adorama.com/?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Shop&utm_content=ProAudioHeader&utm_campaign=<?php echo $utm;?>	" linkname="Shop" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            SHOP</a></td>
                        <td class="audio" style=" text-align: center">
                          <a color="#393F42" href="https://www.adorama.com/l/Professional-Audio?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=ProAudio&utm_content=ProAudioHeader&utm_campaign=<?php echo $utm;?>	" linkname="ProAudio" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            PRO AUDIO</a></td>
                        												<td class="lenses" style=" text-align: center">
                          <a color="#393F42" href="https://www.adorama.com/l/Professional-Audio/Microphones-and-Accessories?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Mics&utm_content=ProAudioHeader&utm_campaign=<?php echo $utm;?>	" linkname="Mics" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            MICS</a></td>
                        
                        
												<td class="headphones" style=" text-align: center">
                          <a color="#393F42" href="https://www.adorama.com/l/Professional-Audio/Headphones-and-Earphones?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Headphones&utm_content=ProAudioHeader&utm_campaign=<?php echo $utm;?>	" linkname="Headphones" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            HEADPHONES</a></td>

												<td class="video" style=" text-align: center">
                          <a color="#393F42" href="https://www.adorama.com/l/Professional-Audio/Speakers-and-Monitors?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Speakers&utm_content=ProAudioHeader&utm_campaign=<?php echo $utm;?>	" linkname="Speakers" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            SPEAKERS</a></td>

												<td class="deals" style=" text-align: center">
                          <a href="https://www.adorama.com/rebates/l/Professional-Audio?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Sale&utm_content=ProAudioHeader&utm_campaign=<?php echo $utm;?>	" linkname="Sale" style="text-decoration: none; color: #B92E2C; font-weight: bold;font-size: 12px;" target="_blank">
                            SALE</a></td>
											</tr>
										</tbody>
									</table>
