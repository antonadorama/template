		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_CanonCoupon_110317"; ?>
					
					<?php $ttl = "Grab the Lowest Prices of the Year on Canon Zoom, Telephoto, Wide Angle Lenses & More!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_1.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_2.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_3.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_4.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_5.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_6.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_7.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_8.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_9.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_10.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_11.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_12.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_13.php"); ?>
					
					<?php include_once("Other/CanonCoupon/p_14.php"); ?>
