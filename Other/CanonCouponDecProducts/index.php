		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_CanonCouponDecProducts_122117"; ?>
					
					<?php $ttl = "Grab End of the Year Canon Lens Clearance Deals + Coupon Offer!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
	
					<?php include_once("Other/CanonCouponDecProducts/p_1.php"); ?>

					<?php include_once("Other/CanonCouponDecProducts/p_2.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_3.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_4.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_5.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_6.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_7.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_8.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_9.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_10.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_11.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_12.php"); ?>
					
					<?php include_once("Other/CanonCouponDecProducts/p_13.php"); ?>
					
					<?php include_once("Other/CanonCouponDecPostcard/care.php"); ?>
