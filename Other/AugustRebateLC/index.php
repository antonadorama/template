		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_August_Rebate_080917"; ?>
					
					<?php $ttl = "Hurry & catch our new August rebates. Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/AugustRebateLC/p_1.php"); ?>
					
					<?php include_once("Other/AugustRebateLC/p_2.php"); ?>
					
					<?php include_once("Other/AugustRebateLC/p_3.php"); ?>
					
					<?php include_once("Other/AugustRebateLC/p_4.php"); ?>
					
					<?php include_once("Other/AugustRebateLC/devider.php"); ?>
					
					<?php include_once("Other/AugustRebateLC/p_5.php"); ?>		
