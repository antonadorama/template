		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php //$utm = "Email_NCPA_060717"; ?>
					
					<?php //$ttl = "Six reasons why NCPA members shop with Adorama"; ?>
					
					
					<?php $utm = "Email_TIPS_060717"; ?>
					
					<?php $ttl = "Six reasons why TIPS/TAPS members shop with Adorama"; ?>
					
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- NCPA--->
					<?php //include_once("Other/Coop/p_1.php"); ?>
					
					<!-- TIPS--->
					<?php include_once("Other/Coop/p_1_2.php"); ?>
					
					<?php include_once("Other/Coop/p_2.php"); ?>
					
					<?php include_once("Other/Coop/p_3.php"); ?>
