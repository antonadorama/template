              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="mailto:govsales@adorama.com?Subject=Quote Request" target="_blank" 
                       linkname="Email For A Quote">
                    <img src="image_library/org_1/1646/eMail_Postcard_v2-Cooperatives_02_2.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Email For A Quote" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
