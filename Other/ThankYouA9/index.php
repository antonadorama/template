		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Sony_A9_Arrives"; ?>
					
					<?php $ttl = "Great news! You’ll have  your Sony A9 tomorrow! Here’s what else you need to know…"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					
					<?php include_once("Other/ThankYouA9/p1.php"); ?>
