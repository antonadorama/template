		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_WinterWriteoffOneDaySale_122117"; ?>
					
					<?php $ttl = "Get up to 65% off now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
	
					<?php include_once("Other/WinterWriteoff/p_1.php"); ?>
					
					<?php include_once("Other/WinterWriteoff/p_2.php"); ?>
					
					<?php include_once("Other/WinterWriteoff/p_3.php"); ?>
