		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_SpringClearanceSaleBrowsed_053018"; ?>
					
					<?php $ttl = "Spring Sale Going On NOW!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("Other/SpringClearanceB/p_1_1.php"); ?>
          <?php include_once("Other/SpringClearanceB/c.php"); ?>
          <?php include_once("Other/SpringClearanceB/p_1_2.php"); ?>         
          
          <?php include_once("Other/SpringClearance/p_2.php"); ?>
          <?php include_once("Other/SpringClearance/p_3.php"); ?>
          
          <?php include_once("Other/SpringClearance/p_4.php"); ?>
          <?php include_once("Other/SpringClearance/p_5.php"); ?>
