		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Trade_022018"; ?>
					
					<?php $ttl = "Trade In Your Old Gear for Cash or Credit! Your Old Gear is Worth Something - Find Out How Much!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>

											
					<?php include_once("Other/TradeEmail_022018/p_1.php"); ?>
