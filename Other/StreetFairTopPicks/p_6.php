                ...
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/g/Street-Fair-2017-Specials?emailprice=t&utm_source=slgt&utm_medium=email&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="Street_Fair_Specials_Footer_Strip">
                    <img src="image_library/org_1/1671/Footer.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
												 alt="Street Fair Specials Footer" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
