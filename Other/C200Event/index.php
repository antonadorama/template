		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_C200_Event_081517"; ?>
					
					<?php $ttl = "Join Adorama and Casey Stein for an in depth look as a triathlete trains to reach his goal and complete an Ironman."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/C200Event/p_1.php"); ?>
