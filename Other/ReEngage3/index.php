...
<body style="min-width: 100%; padding: 0; margin: 0; -webkit-text-size-adjust: none; background-color: #e3e3e3;">
    ...
    <?php include_once("Other/blocks/reengage_fix.php"); ?>	
		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailReEngageIII_ReEng3"; ?>
					
					<?php $ttl = "Just For You: High-Quality Refurbished Savings of Up To 70% OFF + 90 Day Return to Manufacturer Warranties!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
          <?php include_once("Other/ReEngage3/p_1.php"); ?>
          <?php include_once("Other/ReEngage3/p_2.php"); ?>
