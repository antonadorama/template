...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_AccessorySale_072219"; ?>
					
					<?php $ttl = "Our Accessory Sale is ON! Grab these hot deals on all the best gear to get your perfect shot"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/JulyAccessorySale/p_1.php"); ?>

          <?php include_once("Other/JulyAccessorySale/p_3.php"); ?>
          <?php include_once("Other/JulyAccessorySale/p_4.php"); ?>
          <?php include_once("Other/JulyAccessorySale/p_5.php"); ?>
          <?php include_once("Other/JulyAccessorySale/p_6.php"); ?>
          <?php include_once("Other/JulyAccessorySale/p_7.php"); ?>
          <?php include_once("Other/JulyAccessorySale/p_8.php"); ?>
