		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_NewMayRebates_050718"; ?>
					
					<?php $ttl = "Save 100s w/NEW Deals From Top Brands. Shop Now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
															
					<?php include_once("Other/NewMayRebates/p_1.php"); ?>
          <?php include_once("Other/NewMayRebates/p_2.php"); ?>
          <?php include_once("Other/NewMayRebates/p_3.php"); ?>
          <?php include_once("Other/NewMayRebates/p_4.php"); ?>
          <?php include_once("Other/NewMayRebates/p_5.php"); ?>
          <?php include_once("Other/NewMayRebates/p_6.php"); ?>
          
          <?php include_once("Other/NewMayRebates/p_7.php"); ?>
          <?php include_once("Other/NewMayRebates/p_8.php"); ?>
          <?php include_once("Other/NewMayRebates/p_9.php"); ?>
          <?php include_once("Other/NewMayRebates/p_10.php"); ?>
          <?php include_once("Other/NewMayRebates/p_11.php"); ?>
