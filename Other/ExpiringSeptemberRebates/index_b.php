...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_ExpiringSeptemberRebatesBrowsed_092719"; ?>
					
					<?php $ttl = "These instant rebates will expire soon, so don't wait to save!"; ?>
          ...
          <?php include_once("Other/ExpiringSeptemberRebates/p_1_browsed_1.php"); ?>
          <?php include_once("Other/ExpiringSeptemberRebates/p_1_browsed_2.php"); ?>
          <?php include_once("Other/ExpiringSeptemberRebates/p_1_browsed_3.php"); ?>
          ...
          <?php //include_once("Other/ExpiringSeptemberRebates/p_9.php"); ?>
          <?php //include_once("Other/ExpiringSeptemberRebates/devider.php"); ?>
          <?php //include_once("Other/ExpiringSeptemberRebates/p_1_white.php"); ?>

          
          <?php //include_once("Other/ExpiringSeptemberRebates/p_8.php"); ?>
