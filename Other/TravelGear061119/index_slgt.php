...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_TravelGear_061119"; ?>
					
					<?php $ttl = "Capture your next trip and save on new gear! Up to 50% off, shop now >>"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/TravelGear061119/p_1.php"); ?>
          <?php include_once("Other/TravelGear061119/p_2.php"); ?>
          <?php include_once("Other/TravelGear061119/p_3.php"); ?>
          <?php include_once("Other/TravelGear061119/p_4.php"); ?>
          <?php include_once("Other/TravelGear061119/p_5.php"); ?>
          <?php include_once("Other/TravelGear061119/p_6.php"); ?>
          <?php include_once("Other/TravelGear061119/p_7.php"); ?>
