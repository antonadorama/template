		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_FlashSaleDynamic_101718"; ?>
					
					<?php $ttl = "Enjoy up to 50% off on ##SMFMT_PROPERCASE[\second_level_category]## while supplies last. Hurry, shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php //include_once("Other/FlashSale/p_1.php"); ?>
          <?php //include_once("Other/FlashSale/p_1_nikon.php"); ?>
          <?php //include_once("Other/FlashSale/p_1_canon.php"); ?>
          <?php //include_once("Other/FlashSale/p_1_sony.php"); ?>
          <?php //include_once("Other/FlashSale/p_1_panasonic.php"); ?>
          <?php //include_once("Other/FlashSale/p_1_fujifilm.php"); ?>
          
          <?php include_once("Other/FlashSale/p_1_browsedtop.php"); ?>
          <?php include_once("Other/FlashSale/c.php"); ?>
          <?php include_once("Other/FlashSale/p_1_browsebottom.php"); ?>
          
          <?php include_once("Other/FlashSale/p_2.php"); ?>
          <?php include_once("Other/FlashSale/p_3.php"); ?>
          <?php include_once("Other/FlashSale/p_4.php"); ?>
          <?php include_once("Other/FlashSale/p_5.php"); ?>
          <?php include_once("Other/FlashSale/p_6.php"); ?>
          
          <?php include_once("Other/FlashSale/p_7.php"); ?>
