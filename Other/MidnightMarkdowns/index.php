...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_MidnightMarkdownsBrowsed_060718"; ?>
          <?php $ttl = "Snooze, You Lose! Midnight Deals on ##SMFMT_PROPERCASE[\second_level_category]## and More Just Came Online!"; ?>

					<?php include_once("Other/blocks/header.php"); ?>		
          
					<?php //include_once("Other/MidnightMarkdowns/p_1.php"); ?>
          <?php //include_once("Other/MidnightMarkdowns/p_1_sony.php"); ?>
          <?php //include_once("Other/MidnightMarkdowns/p_1_nikon.php"); ?>
          <?php //include_once("Other/MidnightMarkdowns/p_1_apple.php"); ?>
          
          <?php include_once("Other/MidnightMarkdowns/p_1_browsed_1.php"); ?>
          <?php include_once("Other/MidnightMarkdowns/p_1_browsed_2.php"); ?>
          <?php include_once("Other/MidnightMarkdowns/p_1_browsed_3.php"); ?>
          
          <?php include_once("Other/MidnightMarkdowns/p_2.php"); ?>
          <?php include_once("Other/MidnightMarkdowns/p_3.php"); ?>
