		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TravelGearLCOptimail_032619"; ?>
					
					<?php $ttl = "Last chance for savings on travel photography gear!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/TravelGearLC/p_1.php"); ?>
          <?php include_once("Other/TravelGearLC/p_2.php"); ?>
          <?php include_once("Other/TravelGearLC/p_3.php"); ?>
          <?php include_once("Other/TravelGearLC/p_4.php"); ?>
          <?php include_once("Other/TravelGearLC/p_5.php"); ?>
          <?php include_once("Other/TravelGearLC/p_6.php"); ?>
          <?php include_once("Other/TravelGearLC/p_7.php"); ?>
          <?php include_once("Other/TravelGearLC/p_8.php"); ?>
          <?php include_once("Other/TravelGearLC/p_9.php"); ?>
