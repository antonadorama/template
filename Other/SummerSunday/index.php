...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_SummerSundayVIP_081819"; ?>
					
					<?php $ttl = "Summer Sunday Clearance Sale 🔥 grab these hot deals now!"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>   
          
          <?php include_once("Other/SummerSunday/p_0.php"); ?>
          <?php include_once("Other/SummerSunday/p_1.php"); ?>
          <?php include_once("Other/SummerSunday/p_2.php"); ?>
          <?php include("Other/SummerSunday/devider.php"); ?>
          <?php include_once("Other/SummerSunday/p_3.php"); ?>
          <?php include("Other/SummerSunday/devider.php"); ?>
          <?php include_once("Other/SummerSunday/p_4.php"); ?>
