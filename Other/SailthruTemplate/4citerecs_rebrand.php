              ...
              <tbody>
                <tr>
                  <td style="background-color: #ffffff; font-size: 26px; font-family: 'Lato', Helvetica, sans-serif; 
														 font-weight:900; color: #004387; text-align: center; letter-spacing:1px;" align="center" bgcolor="#ffffff">YOU MAY ALSO LIKE</td>
                </tr>
              </tbody>
            </table>
          </div>          
									...
									<td align="center" class="half" height="260">
										...
										<table width="146" height="260" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												<tr height="115">
													<td align="center">
														<a href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/1?_emk={email}&emailprice=t&utm_source=slth&refby=slth&email={email}&utm_medium=email&guid={profile.vars.guid}&utm_term=4CiteBestseller1&utm_content=Body&utm_campaign=<?php echo $utm;?>">
												...
												<tr height="50">
													<td align="center" style="padding-bottom: 2px" valign="bottom">
														<table width="140" border="0" cellspacing="0" cellpadding="0" align="center" class="Btn135">
															<tbody>
																<tr>
																	<td style="font-size: 14px; font-family: 'Lato', Arial, Helvetica, sans-serif; text-align: center; color: #004387; 
																						 font-weight: normal; padding:8px 10px; border:1px solid #004387" height="26" align="center" bgcolor="#ffffff"
																	 valign="middle" width="auto">
																		<a href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/1?_emk={email}&emailprice=t&utm_source=slth&refby=slth&email={email}&utm_medium=email&guid={profile.vars.guid}&utm_term=4CiteBestseller1&utm_content=Body&utm_campaign=<?php echo $utm;?>" 
																			 target="_new" style="text-decoration: none; color: #004387; font-weight: bold;">VIEW ></a></td>
																</tr>
															</tbody>
														</table>
													</td>
									...
									<td align="center" class="half" height="260">
										...
										<table width="146" height="260" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												<tr height="115">
													<td align="center">
														<a href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/2?_emk={email}&emailprice=t&utm_source=slth&refby=slth&email={email}&utm_medium=email&guid={profile.vars.guid}&utm_term=4CiteBestseller2&utm_content=Body&utm_campaign=<?php echo $utm;?>">
