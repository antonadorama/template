		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailReEngageII_ReEng2"; ?>
					
					<?php $ttl = "You've Unlocked Hundreds of Rebates Worth Up To $3,000 on Cameras, Lenses, TV's and Electronics!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
          <?php include_once("Other/ReEngage2/p_1.php"); ?>
          <?php include_once("Other/ReEngage2/p_2.php"); ?>
