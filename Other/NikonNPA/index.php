		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_NikonNPA_090418"; ?>
					
					<?php $ttl = "Mirrorless Reinvented. Welcome to a new era of Nikon imaging. Pre-Order Now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/NikonNPA/p_1.php"); ?>
          <?php include_once("Other/NikonNPA/p_2.php"); ?>
          <?php include_once("Other/NikonNPA/p_3.php"); ?>
          <?php include_once("Other/NikonNPA/p_4.php"); ?>
          <?php include_once("Other/NikonNPA/p_5.php"); ?>
          <?php //include_once("Other/NikonNPA/p_5_2.php"); ?>
          <?php include_once("Other/NikonNPA/p_6.php"); ?>
          <?php include_once("Other/NikonNPA/p_7.php"); ?>
          <?php include_once("Other/NikonNPA/p_8.php"); ?>          
          <?php include_once("Other/NikonNPA/p_9.php"); ?>
          
          <?php include_once("Other/NikonNPA/p_16.php"); ?>
          
          <?php //include_once("Other/NikonNPA/p_10.php"); ?>
          <?php //include_once("Other/NikonNPA/p_11.php"); ?>
          <?php //include_once("Other/NikonNPA/p_12.php"); ?>
          <?php //include_once("Other/NikonNPA/p_13.php"); ?>
          <?php //include_once("Other/NikonNPA/p_14.php"); ?>
          <?php include_once("Other/NikonNPA/p_15.php"); ?>
