		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_JanuaryBundlesExt_012618"; ?>
					
					<?php $ttl = "Shop top brands NOW to get free gear!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/JanuaryBundlesExt/p_1.php"); ?>
          <?php include_once("Other/JanuaryBundlesExt/p_3.php"); ?>
          <?php include_once("Other/JanuaryBundlesExt/p_2.php"); ?>
          
           <?php include_once("Other/JanuaryBundles/p_4.php"); ?> 
           <?php include_once("Other/JanuaryBundlesExt/p_5.php"); ?>
