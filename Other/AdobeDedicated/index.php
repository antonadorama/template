		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Adobe_Dedicated_051617"; ?>
					
					<?php $ttl = "Exclusive 50% OFF Coupon on Adobe Photoshop Elements 15 Inside!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("Other/AdobeDedicated/p_1.php"); ?>
					
					
					<?php include_once("Other/AdobeDedicated/p_2.php"); ?>
					
					<?php include_once("Other/AdobeDedicated/p_3.php"); ?>
