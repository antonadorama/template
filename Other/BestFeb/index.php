		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_BestOfFebruary_022818"; ?>
					
					<?php $ttl = "Discover All Of The Best Of February"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>

											
					<?php include_once("Other/BestFeb/p_1.php"); ?>
					<?php include_once("Other/BestFeb/p_2.php"); ?>
					<?php include_once("Other/BestFeb/p_3.php"); ?>
					<?php include_once("Other/BestFeb/p_4.php"); ?>
