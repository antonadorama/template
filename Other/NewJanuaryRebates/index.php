		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_NewjanuaryRebatesBrowsed_010619"; ?>
					
					<?php $ttl = "January rebates are here, shop ##second_level_category##."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php //include_once("Other/NewJanuaryRebates/p_1.php"); ?>
          <?php //include_once("Other/NewJanuaryRebates/p_canon.php"); ?>
          <?php //include_once("Other/NewJanuaryRebates/p_nikon.php"); ?>
          <?php //include_once("Other/NewJanuaryRebates/p_sony.php"); ?>
          <?php //include_once("Other/NewJanuaryRebates/p_panasonic.php"); ?>
          <?php //include_once("Other/NewJanuaryRebates/p_fujifilm.php"); ?>
          
          <?php include_once("Other/NewJanuaryRebates/p_1_browsed_1.php"); ?>
          <?php include_once("Other/NewJanuaryRebates/p_1_browsed_2.php"); ?>
          <?php include_once("Other/NewJanuaryRebates/p_1_browsed_3.php"); ?>
          
          <?php include_once("Other/NewJanuaryRebates/p_2.php"); ?>
          <?php include_once("Other/NewJanuaryRebates/p_3.php"); ?>
          <?php include_once("Other/NewJanuaryRebates/p_4.php"); ?>			
          <?php include_once("Other/NewJanuaryRebates/p_5.php"); ?>
          <?php include_once("Other/NewJanuaryRebates/p_6.php"); ?>
          <?php include_once("Other/NewJanuaryRebates/p_7.php"); ?>	
