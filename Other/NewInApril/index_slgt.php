...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_NewInAprilOptimail_040219"; ?>
					
					<?php $ttl = "Check out our exclusive April specials, product announcements & more!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/NewInApril/p_1.php"); ?>
          <?php include_once("Other/NewInApril/p_2.php"); ?>
          
          <?php include_once("Other/NewInApril/p_3.php"); ?>
          <?php include_once("Other/NewInApril/p_4.php"); ?>
          <?php include_once("Other/NewInApril/p_5.php"); ?>
          <?php include_once("Other/NewInApril/p_6.php"); ?>
          <?php include_once("Other/NewInApril/p_7.php"); ?>
          <?php include_once("Other/NewInApril/p_8.php"); ?>
