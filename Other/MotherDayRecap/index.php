		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_MotherDayRecap_051018"; ?>
					
					<?php $ttl = "Shop now with love!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
															
					<?php include_once("Other/MotherDayRecap/p_1.php"); ?>
          <?php include_once("Other/MotherDayRecap/p_2.php"); ?>
          
          <?php include_once("Other/MotherDayRecap/p_3.php"); ?>
          <?php include_once("Other/MotherDayRecap/p_4.php"); ?>
          <?php include_once("Other/MotherDayRecap/p_5.php"); ?>
          <?php include_once("Other/MotherDayRecap/p_6.php"); ?>
