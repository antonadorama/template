		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_BlackFriday_BestSellers_113017"; ?>
					
					<?php $ttl = "BACK ON SALE: Our Best Black Friday Gifts, Up To 64% OFF, Return For One Day Only!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("Other/BfBestsellers/p_1.php"); ?>  
