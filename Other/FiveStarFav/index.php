...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_FiveStarFavoritesBrowsed_022119"; ?>
					
					<?php $ttl = "Save up to 40% On ##second_level_categories## when you shop now"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>          
                    
          <?php include_once("Other/FiveStarFav/p_1_top.php"); ?>
          <?php include_once("Other/FiveStarFav/p_1_c.php"); ?>
          <?php include_once("Other/FiveStarFav/p_1_bottom.php"); ?>
          
          
          <?php //include_once("Other/FiveStarFav/p_2.php"); ?>
					<?php //include_once("Other/FiveStarFav/p_1.php"); ?>
          <?php include_once("Other/FiveStarFav/p_3.php"); ?>
