...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_HotAccessoryDealsLC_081619"; ?>
					
					<?php $ttl = "Shop and save on your favorite camera gear before these deals are gone for good"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>   
          
          <?php include_once("Other/HotAccessoryDeals/p_1.php"); ?>
          <?php include_once("Other/HotAccessoryDeals/p_2.php"); ?>
          <?php include_once("Other/HotAccessoryDeals/p_3.php"); ?>
          <?php include_once("Other/HotAccessoryDeals/p_4.php"); ?>
          <?php include_once("Other/HotAccessoryDeals/p_5.php"); ?>
          <?php include_once("Other/HotAccessoryDeals/p_6.php"); ?>
          <?php include_once("Other/HotAccessoryDeals/p_7.php"); ?>
