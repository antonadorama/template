              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    ...
                    <img src="image_library/org_1/1760/VIP-logo-xl.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" alt="Thank You for Your Purchase!" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
		...
		<table style="font-size: 15px; font-family: Arial, Helvetica, sans-serif; color: #5e5e5e; text-align: left; line-height: 18px;
			...
			<tr>
				<td style="padding-top:2px; padding-left:10px; padding-bottom:2px; padding-right:10px;">
					<br />
         Hi ##SMFMT_PROPERCASE[\first_name[Adorama Customer]]##, 
			...
			<tr>
				<td style="padding-top:2px; padding-left:10px; padding-bottom:2px; padding-right:10px;">
         Great news; your VIP360 Membership has been extended! Have you checked in lately on the latest 
					<strong><a href="https://www.adorama.com/specials/l/?sel=Filter-By_Free-Shipping&emailprice=t&utm_campaign=<?php echo $utm;?>" 
																												linkname="VIP360" style="color:#5e5e5e; text-decoration:none;">exclusive VIP360 deals</a></strong>? Now that you’ve been renewed for another year, with every purchase you make, you’ll continue to enjoyed all our VIP360 membership benefits, including:
		     </td>
			</tr>
			...
			<tr>
				<td style="padding-top:2px; padding-left:10px; padding-bottom:2px; padding-right:10px;">
         Thank you for continuing to be a valued Adorama VIP360 Member!
		     </td>
			</tr>
