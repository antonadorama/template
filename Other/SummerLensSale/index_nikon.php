		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
							...
							<tbody>
								<tr>
									<td class="logobrowser" style="width: 470px; color: #A7A9AC; font-size: 14px; padding: 20px 0;">
										<span class="offer">Don't miss incredible savings on Nikon & more!</span>
                    ...
                    <a href="https://www.adorama.com/?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Logo&utm_content=Header&utm_campaign=Email_SummerLensSaleNikon_071219	" linkname="Logo" style="color: inherit" target="_blank">
                      <img alt="ADORAMA - More than a camera store" border="0" src="https://www.adorama.com/col/images/email/logo-x2.png" style="display:block;" width="155" />
                          ...
                          <a color="#393F42" href="https://www.adorama.com/?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Header&utm_campaign=Email_SummerLensSaleNikon_071219	" linkname="Shop" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            SHOP</a></td>
												<td class="cameras" style=" text-align: center">
                          <a color="#393F42" href="https://www.adorama.com/l/Cameras?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Cameras&utm_content=Header&utm_campaign=Email_SummerLensSaleNikon_071219	" linkname="Cameras" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            CAMERAS</a></td>
												<td class="lenses" style=" text-align: center">
                          <a color="#393F42" href="https://www.adorama.com/l/Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Lenses&utm_content=Header&utm_campaign=Email_SummerLensSaleNikon_071219	" linkname="Lenses" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            LENSES</a></td>
												<td class="video" style=" text-align: center">
                          <a color="#393F42" href="https://www.adorama.com/l/Lighting-and-Studio?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Lighting&utm_content=Header&utm_campaign=Email_SummerLensSaleNikon_071219	" linkname="Lighting" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            LIGHTING</a></td>
												<td class="audio" style=" text-align: center">
                          <a color="#393F42" href="https://www.adorama.com/l/Computers/Memory-and-Data-Storage?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Storage&utm_content=Header&utm_campaign=Email_SummerLensSaleNikon_071219	" linkname="Storage" style="text-decoration: none; color: #393F42; font-weight: bold; font-size: 12px; " target="_blank">
                            STORAGE</a></td>
												<td class="deals" style=" text-align: center">
                          <a href="https://www.adorama.com/specials?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Deals&utm_content=Header&utm_campaign=Email_SummerLensSaleNikon_071219	" linkname="Deals" style="text-decoration: none; color: #B92E2C; font-weight: bold;font-size: 12px;" target="_blank">
                            DEALS</a></td>
											</tr>
										</tbody>
									</table>
              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/specials/l/Nikon~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" target="_blank" 
                       >
                    <img src="https://www.adorama.com/col/images/email/Optimail/SummerLensSale/Summer-Lens-Sale-Main-070819-Nikon.gif" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;line-height:0 !important; font-size:0 !important;" class="mobile-full" 
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ECF6F8;" class="vb-container fullwidth" align="center" bgcolor="#ECF6F8" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/g/summer-lens-sale-2019?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" target="_blank" 
                       >
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ffffff;" class="vb-container fullwidth" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td>
                      <a href="https://www.adorama.com/specials/l/Canon~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                         target="_blank">
                  ...
                  <td>
                    <a href="https://www.adorama.com/specials/l/Nikon~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                       target="_blank">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ffffff;" class="vb-container fullwidth" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td>
                      <a href="https://www.adorama.com/specials/l/Panasonic~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                         target="_blank">
                  ...
                  <td>
                    <a href="https://www.adorama.com/specials/l/Olympus~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                       target="_blank">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ffffff;" class="vb-container fullwidth" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td>
                      <a href="https://www.adorama.com/specials/l/Sigma~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                         target="_blank">
                  ...
                  <td>
                    <a href="https://www.adorama.com/specials/l/Pentax~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                       target="_blank">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ffffff;" class="vb-container fullwidth" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td>
                      <a href="https://www.adorama.com/specials/l/Zeiss~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                         target="_blank">
                  ...
                  <td>
                    <a href="https://www.adorama.com/specials/l/Tamron~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                       target="_blank">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ffffff;" class="vb-container fullwidth" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td>
                      <a href="https://www.adorama.com/specials/l/Tokina~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                         target="_blank">
                  ...
                  <td>
                    <a href="https://www.adorama.com/specials/l/Fujifilm~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                       target="_blank">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ffffff;" class="vb-container fullwidth" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td>
                      <a href="https://www.adorama.com/specials/l/Rokinon~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                         target="_blank">
                  ...
                  <td>
                    <a href="https://www.adorama.com/specials/l/Samyang~Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
                       target="_blank">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ECF6F8;" class="vb-container fullwidth" align="center" bgcolor="#ECF6F8" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/l/Lenses/Lens-Filters?sf=Price&st=de&sel=Discount_50-percent-Off-or-More&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" target="_blank" 
                       >
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ECF6F8;" class="vb-container fullwidth" align="center" bgcolor="#ECF6F8" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/l/Lenses/Lens-Accessories?sel=Discount_25-percent-Off-or-More&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Shop&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" target="_blank" 
                       >
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ECF6F8;" class="vb-container fullwidth" align="center" bgcolor="#ECF6F8" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://c38.dyneml.com/campaign/4624563504714/37890/nav.html?_=1553529255&dm_dpid=${deploymentID}&dm_uid=${uid}?refby=optm&utm_campaign=Email_SummerLensSaleNikon_071219&email=[%EMAIL%]&guid=[%GUID%]&emailprice=t" target="_blank" 
									...
									<td align="center" class="half" height="260">
										...
										<table width="146" height="260" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												<tr height="115">
													<td align="center">
														<a linkname="Bestseller1" href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/1?_emk=[%EMAIL%]&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=4CiteBestseller1&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
																...
																<tr>
																	<td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #1385B4; 
																	 ...
																	 valign="middle" width="auto">
																		<a href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/1?_emk=[%EMAIL%]&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=4CiteBestseller1&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
									...
									<td align="center" class="half" height="260">
										...
										<table width="146" height="260" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												<tr height="115">
													<td align="center">
														<a linkname="Bestseller2" href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/2?_emk=[%EMAIL%]&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=4CiteBestseller2&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
															...
															<tbody>
																<tr>
																	<td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #1385B4; 
																						 font-weight: normal; padding:8px 10px; border:1px solid #1385B4" height="26" align="center" bgcolor="#ffffff"
																	 valign="middle" width="auto">
																		<a href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/2?_emk=[%EMAIL%]&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=4CiteBestseller2&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
									...
									<td align="center" class="half">
										...
										<table width="146" height="260" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												<tr height="115">
													<td align="center">
														<a linkname="Bestseller3" href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/3?_emk=[%EMAIL%]&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=4CiteBestseller3&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
															...
															<tbody>
																<tr>
																	<td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #1385B4; 
																						 font-weight: normal; padding:8px 10px; border:1px solid #1385B4" height="26" align="center" bgcolor="#ffffff"
																	 valign="middle" width="auto">
																		<a href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/3?_emk=[%EMAIL%]&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=4CiteBestseller3&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
									...
									<td align="center" class="half" height="260">
										...
										<table width="146" height="260" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												<tr height="115">
													<td align="center">
														<a linkname="Bestseller4" href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/4?_emk=[%EMAIL%]&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=4CiteBestseller4&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
															...
															<tbody>
																<tr>
																	<td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #1385B4; 
																						 font-weight: normal; padding:8px 10px; border:1px solid #1385B4" height="26" align="center" bgcolor="#ffffff"
																	 valign="middle" width="auto">
																		<a href="http://svopn.adorama.com/LiveContent/v2/get_content/2620_03922/94551/lnk/4?_emk=[%EMAIL%]&emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=4CiteBestseller4&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219" 
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #ECF6F8;" class="vb-container fullwidth" align="center" bgcolor="#ECF6F8" border="0" cellpadding="0" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://c38.dyneml.com/campaign/4624563504714/37888/nav.html?_=1553529287&dm_dpid=${deploymentID}&dm_uid=${uid}?refby=optm&utm_campaign=Email_SummerLensSaleNikon_071219&email=[%EMAIL%]&guid=[%GUID%]&emailprice=t" target="_blank" 
											...
											<tbody>
												...
												<tr>
													<td align="center" valign="middle" height="80">
														<a linkname="AdoramaCredit" href="https://www.adorama.com/g/adorama-credit?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ValuePropFinancing&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
													...
													<td align="center" valign="top" height="40" class="title" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #114998">
															...
															<a linkname="Adorama_Credit" href="https://www.adorama.com/g/adorama-credit?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ValuePropFinancing&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
									...
									<td align="center" class="half">
										...
										<table width="146" height="140" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												...
												<tr>
													<td align="center" valign="middle" height="80">
														<a linkname="ExpeditedShipping" href="https://www.adorama.com/help/shippingAndDelivery?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ValuePropFreeShipping&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
													...
													<td align="center" valign="top" height="40" class="title" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #114998">
															...
															<a linkname="Expedited_Shipping" href="https://www.adorama.com/help/shippingAndDelivery?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ValuePropFreeShipping&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
									...
									<td align="center" class="half">
										...
										<table width="146" height="140" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												...
												<tr>
													<td align="center" valign="middle" height="80">
														<a linkname="GiftCard" href="https://www.adorama.com/als.mvc/nspc/GiftCard?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ValuePropGiftCard&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
													...
													<td align="center" valign="top" height="40" class="title" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #114998">
															...
															<a linkname="Gift_Card" href="https://www.adorama.com/als.mvc/nspc/GiftCard?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ValuePropGiftCard&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
									...
									<td align="center" class="half">
										...
										<table width="146" height="140" border="0" cellspacing="3" cellpadding="3" align="center" class="wrap150" bgcolor="#ffffff" style="background-color:#ffffff;">
											<tbody>
												...
												<tr>
													<td align="center" valign="middle" height="80">
														<a linkname="BecomeVIP" href="https://www.adorama.com/g/VIP360?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ValuePropBecomeVIP&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
													...
													<td align="center" valign="top" height="40" class="title" style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #114998">
														...
														<a linkname="Become_VIP" href="https://www.adorama.com/g/VIP360?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ValuePropBecomeVIP&utm_content=Body&utm_campaign=Email_SummerLensSaleNikon_071219">
...
<table cellpadding="0" cellspacing="0" width="100%" style="max-width:640px;">
                    ...
                    <a href="https://www.adorama.com/l/Cameras?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Cameras&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="CamerasFooter" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                    ...
                    <a href="https://www.adorama.com/l/Cameras?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Cameras&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="CamerasFooter" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                      CAMERAS
									...
									<td align="center" class="menuimage" style="width: 16.666%; text-align: center" width="16.666%">
                    <a href="https://www.adorama.com/l/Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Lenses&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="LensesIcon" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                    ...
                    <a href="https://www.adorama.com/l/Lenses?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Lenses&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="LensesIcon" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                      LENSES
									...
									<td align="center" class="menuimage" style="width: 16.666%; text-align: center" width="16.666%">
                    <a href="https://www.adorama.com/l/Lighting-and-Studio?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Lighting&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="LightingIcon" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                    ...
                    <a href="https://www.adorama.com/l/Lighting-and-Studio?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Lighting&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="LightingIcon" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                      LIGHTING
									...
									<td align="center" class="menuimage" style="width: 16.666%; text-align: center" width="16.666%">
                    <a href="https://www.adorama.com/l/Computers/Memory-and-Data-Storage?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Storage&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="StorageIcon" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                    ...
                    <a href="https://www.adorama.com/l/Computers?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Computers&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="ComputersIcon" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                    ...
                    <a href="https://www.adorama.com/l/Computers?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Computers&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="ComputersIcon" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
                      COMPUTERS
									...
									<td align="center" class="menuimage" style="width: 16.666%; text-align: center" width="16.666%">
                    <a href="https://www.adorama.com/l/Video-Equipment/Drones-and-Accessories?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Drone&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="DroneIcon" style="color: #A7A9AC; font-size: 11px; text-decoration: none;" target="_blank">
								...
								<tr>
									...
									<table cellpadding="0" cellspacing="0" class="wrap100" width="100%">
										<tbody>
											<tr>
												<td align="center">
													<a class="bottomsubmenu" href="https://www.adorama.com/help/contactus?utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Contact&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" 
												...
												<td align="center">
													<a class="bottomsubmenu" href="https://www.adorama.com/Als.Mvc/nspc/MyAccount?utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Account&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219#dashboard" 
												...
												<td align="center">
													<a class="bottomsubmenu" href="https://www.adorama.com/trackOrder?utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Status&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" 
					...
					<tr>
						...
						<table bgcolor="#EEF0F1" cellpadding="0" cellspacing="0" class="wrap100" width="100%">
                          ...
                          <a href="https://www.adorama.com/?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Logo&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="LogoFooter" style="color: inherit" target="_blank">
                          ...
                          <a href="https://www.adoramarentals.com/?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=ARC&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="ARCFooter" style="color: inherit" target="_blank">
                            <img alt="" src="https://www.adorama.com/col/images/email/logo-arc-x2.png" width="51" />
                          </a>
                        </td>
												<td align="center" class="fbottom">
                          <a href="https://www.adoramapix.com/app/home?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Pix&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="PixFooter" style="color: inherit" target="_blank">
                            <img alt="" src="https://www.adorama.com/col/images/email/logo-pix-x2.png" width="44" />
                          </a>
                        </td>
												<td align="center" class="fbottom">
                          <a href="https://www.adorama.com/pages/usedQuote?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Trade&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="TradeFooter" style="color: inherit" target="_blank">
                    ...
                    <a href="https://www.adorama.com/?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Text&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" 
           ...
           <td class="bottomlinkscredentials" style="color: #A7A9AC; font-size: 14px; text-align: center;">
						<p style="padding: 0 30px; margin:5px;">
							Email sent to: 
							<a href="https://www.adorama.com/Als.Mvc/nspc/MyAccount?guid=[%GUID%]&pageMode=manage&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&utm_term=Preferences&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219#emailpref" 
                ...
                [%EMAIL%]</a> </p>
                      ...
                      <strong>This email may be considered promotional or advertising.</strong> If you wish to be removed from this email list, you can unsubscribe below. 
             		                ...
             		                <p style="padding: 0 30px; text-align: center; margin: 2px; color: #A7A9AC;">
             To manage your email preferences, <a href="https://www.adorama.com/Als.Mvc/nspc/MyAccount?guid=[%GUID%]&pageMode=manage&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&utm_term=Preferences&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219#emailpref" 
             ...
             <p style="padding: 0 30px; text-align: center; margin: 5px; color: #A7A9AC;">
							...
							<p style="padding: 0 30px; text-align: center; margin: 5px; color: #A7A9AC;">
								...
								<a href="https://www.adorama.com/help/termsAndConditions?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Terms&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="Terms" style="color: #A7A9AC; text-decoration:underline">
									Terms</a> | 
								<a href="https://www.adorama.com/privacy?emailprice=t&utm_source=optm&refby=optm&email=[%EMAIL%]&utm_medium=email&guid=[%GUID%]&utm_term=Terms&utm_content=Footer&utm_campaign=Email_SummerLensSaleNikon_071219" linkname="Privacy" style="color: #A7A9AC; text-decoration: underline">
									Privacy</a></p>
						</td>
					</tr>
					<!-- End Terms -->
