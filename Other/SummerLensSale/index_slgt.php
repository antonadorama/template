...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_SummerLensSaleMain_071219"; ?>
					
					<?php $ttl = "It's time to shop & save on lenses for your summer adventures"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/SummerLensSale/p_1.php"); ?>
          <?php include_once("Other/SummerLensSale/p_2.php"); ?>
          <?php include_once("Other/SummerLensSale/p_3.php"); ?>
          <?php include_once("Other/SummerLensSale/p_4.php"); ?>
          <?php include_once("Other/SummerLensSale/p_5.php"); ?>
          <?php include_once("Other/SummerLensSale/p_6.php"); ?>
          <?php include_once("Other/SummerLensSale/p_7.php"); ?>
          <?php include_once("Other/SummerLensSale/p_8.php"); ?>
          <?php include_once("Other/SummerLensSale/p_9.php"); ?>
          <?php include_once("Other/SummerLensSale/p_10.php"); ?>
