		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_AppleSale_051718"; ?>
					
					<?php $ttl = "Enjoy up to 32% OFF Apple products. Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
          <?php include_once("Other/AppleSale_051718/countdown.php"); ?>
					<?php include_once("Other/AppleSale_051718/p_1.php"); ?>
          <?php include_once("Other/AppleSale_051718/p_2.php"); ?>
          <?php include_once("Other/AppleSale_051718/p_3.php"); ?>
          <?php include_once("Other/AppleSale_051718/p_4.php"); ?>
          <?php include_once("Other/AppleSale_051718/p_5.php"); ?>
          <?php include_once("Other/AppleSale_051718/p_6.php"); ?>
          <?php include_once("Other/AppleSale_051718/p_7.php"); ?>
          <?php include_once("Other/AppleSale_051718/p_8.php"); ?>
