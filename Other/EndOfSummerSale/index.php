...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_EndOfSummerSaleCategory_092119"; ?>
					
					<?php $ttl = "End of Summer Sale // Shop now!"; ?>
          ...
          <?php include_once("Other/EndOfSummerSale/p_1_browsed_1.php"); ?>
          <?php include_once("Other/EndOfSummerSale/p_1_browsed_2.php"); ?>
          <?php include_once("Other/EndOfSummerSale/p_1_browsed_3.php"); ?>
          ...
          <?php //include_once("Other/EndOfSummerSale/p_9.php"); ?>
          <?php //include_once("Other/EndOfSummerSale/devider.php"); ?>
          <?php //include_once("Other/EndOfSummerSale/p_1_white.php"); ?>

          
          <?php //include_once("Other/EndOfSummerSale/p_8.php"); ?>
          <?php include_once("Other/EndOfSummerSale/FeaturedBannerOptm_slth.php"); ?>
