...
<tr>
  <td>
    <table id="ko_imageBlock_5" style="background-color: #6d2c34;" class="vb-outer" bgcolor="#6d2c34" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
                ...
                <tr>
                  <td align="center" valign="top">
                    <a href="{profile.vars.fourcite_second_level_category_url}?sel=Filter-By_Specials&emailprice=t&utm_source=slth&refby=slth&email={email}&utm_medium=email&guid={profile.vars.guid}&utm_term=Shop&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       >
                    <img src="https://www.adorama.com/col/images/email/Optimail/EndOfSummerSale/adorama_9-20_end-of-summer_dynamic_2_03.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;line-height:0 !important; font-size:0 !important;" class="mobile-full" 
