              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://c38.dyneml.com/campaign/4624563504714/41188/nav.html?_=1568645819&dm_dpid=${deploymentID}&dm_uid=${uid}?refby=slth&utm_campaign=<?php echo $utm;?>&email={email}&guid={profile.vars.guid}&emailprice=t&utm_source=slth&refby=slth&utm_medium=email&utm_term=ContentBanner&utm_content=Body" target="_blank" 
                       >
                    <img src="https://c38.dyneml.com/campaign/4624563504714/41188/image_swap.png?_=1568645819&dm_dpid=${deploymentID}&dm_uid=${uid}" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Custom Featured Banner" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
