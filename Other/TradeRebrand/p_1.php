<tr>
  <td>
    <table id="ko_imageBlock_5" style="background-color: #F3F3F3;" class="vb-outer" bgcolor="#F3F3F3" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/pages/usedQuote?emailprice=t&utm_source=slth&email={email}&utm_medium=email&guid={profile.vars.guid}&utm_term=GetQuote&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       >
                    <img src="https://www.adorama.com/col/images/email/Optimail/Trade_092619/Trade-Email-MKT-27964.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
