                                  ...
                                  <tr>
                                    <td class="links-color" align="left" valign="top" width="100%">
                                      <a href="https://www.adorama.com/##json_accessories.sku_1##.html?emailprice=t&utm_source=slgt&utm_medium=email&utm_content=Body&utm_campaign=<?php echo $utm;?>" 
                                         target="_blank" linkname="FP_##json_accessories.sku_1##">
                                      <img src="https://www.adorama.com/images/Large/##json_accessories.sku_1##.jpg" style="border: 0px;display: block;vertical-align: top;width: 100%;height: auto;" 
                            ...
                            <td class="links-color" style="padding-bottom: 9px;" align="left" valign="top" width="100%"><!--content table start-->
                              ...
                              <table class="vb-content" style="border-collapse: separate;width: 100%; -moz-box-shadow: 0 0 3px rgb(201, 201, 201); -webkit-box-shadow: 0 0 3px rgb(201, 201, 201); box-shadow: 0 0 3px rgb(201, 201, 201); background-color:#ffffff;" 
                                ...
                                <tbody>
                                  <tr>
                                    <td class="links-color" align="left" valign="top" width="100%">
                                      <a href="https://www.adorama.com/##json_accessories.sku_2##.html?emailprice=t&utm_source=slgt&utm_medium=email&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                                         linkname="FP_##json_accessories.sku_2##">
                                      <img src="https://www.adorama.com/images/Large/##json_accessories.sku_2##.jpg" style="border: 0px;display: block;vertical-align: top;width: 100%;height: auto;" 
                                           class="mobile-full" alt="" height="135" hspace="0" border="0" vspace="0" width="135" />
                                      </a>
                                        </td>
                                  </tr>
                            ...
                            <td class="links-color" style="padding-bottom: 9px;" align="left" valign="top" width="100%">
                              ...
                              <table class="vb-content" style="border-collapse: separate;width: 100%; -moz-box-shadow: 0 0 3px rgb(201, 201, 201); -webkit-box-shadow: 0 0 3px rgb(201, 201, 201); box-shadow: 0 0 3px rgb(201, 201, 201); background-color:#ffffff;" 
                                ...
                                <tbody>
                                  <tr>
                                    <td class="links-color" align="left" valign="top" width="100%">
                                      <a href="https://www.adorama.com/##json_accessories.sku_3##.html?emailprice=t&utm_source=slgt&utm_medium=email&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" linkname="FP_##json_accessories.sku_3##">
                                      <img src="https://www.adorama.com/images/Large/##json_accessories.sku_3##.jpg" style="border: 0px;display: block;vertical-align: top;width: 100%;height: auto;" class="mobile-full" alt="" 
