		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_MidSummer_Sale_LC_072517"; ?>
					
					<?php $ttl = "Hurry & get up to 60% OFF. Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/MidSummer/p_1.php"); ?>	
					
					<?php include_once("Other/MidSummer/p_3.php"); ?>	
