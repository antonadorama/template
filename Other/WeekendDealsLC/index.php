...
<table bgcolor="#F3F3F3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_WeekendDealslcDynamic_102719"; ?>
					
					<?php $ttl = "TTL"; ?>
          
					<?php include_once("Other/blocks/header_rebrand.php"); ?>             

          <?php include_once("Other/WeekendDealsLC/p_1_browsed_1.php"); ?>
          <?php include_once("Other/WeekendDealsLC/p_1_browsed_2.php"); ?>
          <?php include_once("Other/WeekendDealsLC/p_1_browsed_3.php"); ?>
