...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_PanasonicInstantRebates_081819"; ?>
					
					<?php $ttl = "Shop now & grab these HUGE limited time instant rebates!"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>   
          

          <?php include_once("Other/PanasonicInstantRebates/p_1.php"); ?>
          <?php include_once("Other/PanasonicInstantRebates/p_2.php"); ?>
          <?php include_once("Other/PanasonicInstantRebates/p_3.php"); ?>
          <?php include_once("Other/PanasonicInstantRebates/p_4.php"); ?>
          <?php include_once("Other/PanasonicInstantRebates/p_5.php"); ?>
          <?php include_once("Other/PanasonicInstantRebates/p_6.php"); ?>
          <?php include_once("Other/PanasonicInstantRebates/p_7.php"); ?>
          <?php include_once("Other/PanasonicInstantRebates/p_8.php"); ?>
