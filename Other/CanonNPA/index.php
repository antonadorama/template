...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_CanonNPA_060718"; ?>
          <?php $ttl = "Pre-order the newest Canon lenses today!"; ?>

					<?php include_once("Other/blocks/header.php"); ?>		
          
					<?php include_once("Other/CanonNPA/p_1.php"); ?>
          <?php include_once("Other/CanonNPA/p_2.php"); ?>
          <?php include_once("Other/CanonNPA/p_3.php"); ?>
          <?php include_once("Other/CanonNPA/p_4.php"); ?>
          <?php include_once("Other/CanonNPA/p_5.php"); ?>
