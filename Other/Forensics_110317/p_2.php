              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/searchsite/default.aspx?page=1&SearchInfo=nightvision+infrared+illuminators&productVersion=20161123083530&lcuVersion=27832&emailprice=t&utm_source=slgt&refby=slgt&utm_medium=email&guid=##GUID##&utm_term=Shop&utm_content=Header&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="InfraredIlliminations">
                    <img src="image_library/org_1/2645/eMail_Postcard-Foresnics-Fujifilm_XT1R_02.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Infrared Illiminations" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
