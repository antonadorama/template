...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_Clearance_051419"; ?>
					
					<?php $ttl = "Enjoy big savings during our warehouse clearance. 💰 Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/Clearance_051419/p_1.php"); ?>
          <?php include_once("Other/Clearance_051419/p_2.php"); ?>
          <?php include_once("Other/Clearance_051419/p_3.php"); ?>
          <?php include_once("Other/Clearance_051419/p_4.php"); ?>
          <?php include_once("Other/Clearance_051419/p_5.php"); ?>
          <?php include_once("Other/Clearance_051419/p_6.php"); ?>
