		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_DJINPA_082318"; ?>
					
					<?php $ttl = "New Releases from DJI Mavic 2 Pro & Mavic 2 Zoom. Pre-Order Now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/DJINPA/p_1.php"); ?>
          <?php include_once("Other/DJINPA/p_2.php"); ?>
          <?php include_once("Other/DJINPA/p_3.php"); ?>
          <?php include_once("Other/DJINPA/p_4.php"); ?>
