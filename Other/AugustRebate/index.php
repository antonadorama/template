		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_August_Rebate_080817"; ?>
					
					<?php $ttl = "Don't miss out on new August rebates. Shop now! "; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/AugustRebate/p_1.php"); ?>
					
					<?php include_once("Other/AugustRebate/p_2.php"); ?>
					
					<?php include_once("Other/AugustRebate/p_3.php"); ?>
					
					<?php include_once("Other/AugustRebate/p_4.php"); ?>
					
					<?php include_once("Other/AugustRebate/devider.php"); ?>
					
					<?php include_once("Other/AugustRebate/p_5.php"); ?>		
