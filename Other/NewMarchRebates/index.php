		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_NewMarchRebatesFujifilm_030319"; ?>
					
					<?php $ttl = "Save on Fujifilm now with March Instant Rebates"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php //include_once("Other/NewMarchRebates/p_1.php"); ?>
          
          <?php //include_once("Other/NewMarchRebates/p_1_canon.php"); ?>
          <?php //include_once("Other/NewMarchRebates/p_1_nikon.php"); ?>
          <?php //include_once("Other/NewMarchRebates/p_1_sony.php"); ?>
          <?php //include_once("Other/NewMarchRebates/p_1_panasonic.php"); ?>
          <?php include_once("Other/NewMarchRebates/p_1_fujifilm.php"); ?>
          
          <?php //include_once("Other/NewMarchRebates/p_1_top.php"); ?>
          <?php //include_once("Other/NewMarchRebates/p_1_c.php"); ?>
          <?php //include_once("Other/NewMarchRebates/p_1_bottom.php"); ?>
          
          <?php include_once("Other/NewMarchRebates/p_2.php"); ?>
          <?php include_once("Other/NewMarchRebates/p_3.php"); ?>
          <?php include_once("Other/NewMarchRebates/p_4.php"); ?>
          <?php include_once("Other/NewMarchRebates/p_5.php"); ?>
          <?php include_once("Other/NewMarchRebates/p_6.php"); ?>
          <?php include_once("Other/NewMarchRebates/p_7.php"); ?>
          <?php include_once("Other/NewMarchRebates/p_8.php"); ?>
