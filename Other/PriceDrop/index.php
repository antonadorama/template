		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Price_Drop_061617"; ?>
					
					<?php $ttl = "Save Up To $1000 with New Price Drops on Pro Monitors & Recorders!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
			
					<?php include_once("Other/PriceDrop/p_1.php"); ?>
					
					<?php include_once("Other/PriceDrop/p_2.php"); ?>					
