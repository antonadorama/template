...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_OneDayVIPSale_100219"; ?>
					
					<?php $ttl = "Shop now to save up to 50% // One day only!"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>          
          
          <?php include_once("Other/OneDayVIPSaleOctober/p_1.php"); ?>
          <?php include_once("Other/OneDayVIPSaleOctober/p_2.php"); ?>
          <?php include_once("Other/OneDayVIPSaleOctober/p_4.php"); ?>
          <?php include_once("Other/OneDayVIPSaleOctober/p_3.php"); ?>
         
          
          <?php include_once("Other/OneDayVIPSaleOctober/p_5.php"); ?>
          <?php include_once("Other/CategoryNav/evegreen_cats.php"); ?>
          
          <?php include_once("Other/OneDayVIPSaleOctober/p_6.php"); ?>
