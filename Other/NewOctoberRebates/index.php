...
<body style="min-width: 100%; padding: 0; margin: 0; -webkit-text-size-adjust: none; background-color: #F3F3F3;">
	<p style="display:none;">
		...
		<?php include_once("Other/blocks/style_rebrand.php"); ?>
...
<table bgcolor="#F3F3F3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
			<td align="center" bgcolor="#F3F3F3">
			<table align="center" bgcolor="#F3F3F3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					
					<?php //include_once("Other/blocks/send_button.php"); ?>
					
          <?php $utm = "Email_NewOctoberRebatesDynamic_100619"; ?>
					
					<?php $ttl = "TTL"; ?>
          
					<?php include_once("Other/blocks/header_rebrand.php"); ?>             

          <?php include_once("Other/NewOctoberRebates/p_1_browsed_1.php"); ?>
          <?php include_once("Other/NewOctoberRebates/p_1_browsed_2.php"); ?>
          <?php include_once("Other/NewOctoberRebates/p_1_browsed_3.php"); ?>
