		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_FlashFriday_121517"; ?>
					
					<?php $ttl = "One Day Only! Use Your Exclusive Coupon Code on These Flash Friday Deals!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php //include_once("Other/FlashFriday/p_1_1.php"); ?>
					<?php include_once("Other/FlashFriday_121517/p_1.php"); ?>
					
					<?php include("Other/FlashFriday_121517/cupon_code.php"); ?>
					
					<?php include_once("Other/FlashFriday_121517/p_2.php"); ?>
					
					<?php include("Other/FlashFriday_121517/cupon_code.php"); ?>
					
					<?php include_once("Other/FlashFriday_121517/p_3.php"); ?>
