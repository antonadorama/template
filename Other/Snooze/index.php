		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailSnoozeAlarm_Snooze"; ?>
					
					<?php $ttl = "Your 45 day snooze has ended! Come back and see what you've missed!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
          <?php include_once("Other/Snooze/p_1.php"); ?>
          <?php include_once("Other/Snooze/p_2.php"); ?>
          <?php include_once("Other/Snooze/p_3.php"); ?>
          <?php include_once("Other/Snooze/p_4.php"); ?>
          <?php include_once("Other/Snooze/p_5.php"); ?>
