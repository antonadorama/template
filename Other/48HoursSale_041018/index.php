		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_48HoursSale_041018"; ?>
					
					<?php $ttl = "Enjoy up to 60% off our best products for a limited time only. Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/48HoursSale_041018/countdown.php"); ?>	
					
											
					<?php include_once("Other/48HoursSale_041018/p_1.php"); ?>
					<?php include_once("Other/48HoursSale_041018/p_4.php"); ?>
					
					<?php include_once("Other/48HoursSale_041018/p_2.php"); ?>
					<?php include_once("Other/48HoursSale_041018/p_3.php"); ?>
