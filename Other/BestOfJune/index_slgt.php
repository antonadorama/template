...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_BestOfJune_063019"; ?>
					
					<?php $ttl = "Check out our specials of the month, product announcements and more!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/BestOfJune/p_1.php"); ?>
          <?php include_once("Other/BestOfJune/p_2.php"); ?>
          <?php include("Other/BestOfJune/devider.php"); ?>
          <?php include_once("Other/BestOfJune/p_3.php"); ?>
          <?php include("Other/BestOfJune/devider.php"); ?>
          <?php include_once("Other/BestOfJune/p_4.php"); ?>
          <?php include("Other/BestOfJune/devider.php"); ?>
          <?php include_once("Other/BestOfJune/p_5.php"); ?>
