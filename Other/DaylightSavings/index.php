		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_DaylightSavingsBrowsed_031019"; ?>
					
					<?php $ttl = "Save up to 50% on ##second_level_category## when you shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php //include_once("Other/DaylightSavings/p_1.php"); ?>
          
          <?php include_once("Other/DaylightSavings/p_1_top.php"); ?>
          <?php include_once("Other/DaylightSavings/p_1_c.php"); ?>
          <?php include_once("Other/DaylightSavings/p_1_bottom.php"); ?>   
