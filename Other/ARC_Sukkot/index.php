...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php include_once("Other/ARC_Sukkot/p_1.php"); ?>
          <?php include_once("Other/ARC_Sukkot/p_2.php"); ?>   
          <?php include_once("Other/ARC_Sukkot/p_3.php"); ?>   
          <?php include_once("Other/ARC_Sukkot/p_4.php"); ?>   
          <?php include_once("Other/ARC_Sukkot/p_5.php"); ?>   
