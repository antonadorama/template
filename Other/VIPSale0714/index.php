		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_VIP_Sale_071417"; ?>
					
					<?php $ttl = "Don’t Miss 12 Hour Sale!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- VIP360 --> <!-- END of VIP360 -->
					
					<?php include_once("Other/VIPSale0714/countdown.php"); ?>
		
					<?php include_once("Other/VIPSale0714/p_1.php"); ?>
					
					<?php include_once("Other/VIPSale0714/p_2.php"); ?>
					<?php include_once("Other/VIPSale0714/p_3.php"); ?>
					<?php include_once("Other/VIPSale0714/p_4.php"); ?>
