...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_BirthdaySale24HoursLeft_071919"; ?>
					
					<?php $ttl = "To celebrate 44 years, we're giving you incredible savings. Don't miss out!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/BirthdaySale/countdown.php"); ?>
          <?php include_once("Other/BirthdaySale/p_1_lc.php"); ?>
          <?php include_once("Other/BirthdaySale/p_2.php"); ?>
          <?php include_once("Other/BirthdaySale/p_3.php"); ?>
          <?php include_once("Other/BirthdaySale/p_4.php"); ?>
          <?php include_once("Other/BirthdaySale/p_5.php"); ?>
          <?php include_once("Other/BirthdaySale/p_6.php"); ?>
          <?php include_once("Other/BirthdaySale/p_7.php"); ?>
          <?php include_once("Other/BirthdaySale/p_8.php"); ?>
