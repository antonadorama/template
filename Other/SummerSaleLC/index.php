...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php //$utm = "Email_SummerSale_062318"; ?>
          <?php //$ttl = "Don't miss out! Save up to 50%... this is your last chance!"; ?>
          
          <?php $utm = "Email_SummerSaleDyn_062318"; ?>
          <?php $ttl = "Don't miss out! Save On ##SMFMT_PROPERCASE[\second_level_category]##."; ?>

					<?php include_once("Other/blocks/header.php"); ?>          
         
          <?php include_once("Other/SummerSaleLC/p_1_browsed_1.php"); ?>
          <?php include_once("Other/SummerSaleLC/p_1_browsed_2.php"); ?>
          <?php include_once("Other/SummerSaleLC/p_1_browsed_3.php"); ?>
          
          <?php //include_once("Other/SummerSaleLC/p_1.php"); ?>
          
          
          
          <?php include_once("Other/SummerSaleLC/p_2.php"); ?>
