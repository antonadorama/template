...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php include("Other/SailthruCategory/p_1.php"); ?>
          <?php include_once("Other/SailthruCategory/p_1_white.php"); ?>
          <?php include("Other/SailthruCategory/p_1.php"); ?>
          <?php include("Other/SailthruCategory/2citerec_1.php"); ?>
          <?php include("Other/SailthruCategory/2citerec_2.php"); ?>
