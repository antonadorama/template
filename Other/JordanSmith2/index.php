		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailJordanSmith_2"; ?>
					
					<?php $ttl = "Jordan Smith Workshop 2"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("Other/JordanSmith2/p1.php"); ?>
					
					<?php include_once("Other/JordanSmith2/p2.php"); ?>
					
					<?php include_once("Other/JordanSmith2/p3.php"); ?>				
					
					<?php include_once("Other/JordanSmith2/p4.php"); ?>
					
					<?php include_once("Other/JordanSmith2/p5.php"); ?>
