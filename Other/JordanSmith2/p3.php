                ...
                <tr>
                  <td align="center" valign="top">
                    <a href="http://learnprofessionalphotography.com/?emailprice=t&utm_source=slgt&utm_medium=email&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="Matthew_Jordan_Smith_Workshop_Text_Block">
                    <img src="image_library/org_1/1347/main_content.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" alt="Message" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
