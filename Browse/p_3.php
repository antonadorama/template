		...
		<table border="0" cellpadding="0" cellspacing="0" class="wrap100" width="640" bgcolor="#ffffff">
			<tbody>
				<tr>
					...
					<td align="center" class="valueprop" style="width: 25%; text-align: center" width="25%">
						<a href="http://www.adorama.com/help/shippinganddelivery#receive?refby=slgt&utm_source=slgt&utm_medium=email&utm_term=SameDayShipping&utm_content=Value+Props&utm_campaign=<?php echo $utm;?>" linkname="Browse_SameDayShipping" style="color: #A7A9AC; font-size: 11px; text-decoration: none;"
					...
					<td align="center" class="valueprop" style="width: 25%;  white-space: nowrap; text-align: center" width="25%">
						<a href="http://www.adorama.com/help/returnPolicy?refby=slgt&utm_source=slgt&utm_medium=email&utm_term=FreeReturns&utm_content=Value+Props&utm_campaign=<?php echo $utm;?>" linkname="Browse_FreeReturns" style="color: #A7A9AC; font-size: 11px; text-decoration: none;"
