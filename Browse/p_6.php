				...
				<tr>
					<td align="center" valign="middle">
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="" width="">
							<tbody>
								<tr>
									<td class="copy" style="font-size: 18px; font-family: Arial, Helvetica, sans-serif; color: #006ab2; text-transform: uppercase; text-align: center; line-height: normal" valign="middle"><br> Shop the latest Specials by category!<br> &nbsp;
									</td>
								</tr>
								<tr>
				...
				<tr>
					<td align="center" style="padding-top: 12px; padding-bottom: 12px">
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0" class="" width="100%">
							<tbody>
								<tr>
									<td align="center" class="navsplit" valign="top" width="25%" style="width:25%; max-width:280px;">
										<table align="center" border="0" cellpadding="0" cellspacing="0" class="subnav" width="100%" width="100%; max-width:320px;">
											<tbody>
												<tr>
