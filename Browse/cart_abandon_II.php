		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailCartAbandonII"; ?>

					<?php $ttl = "The deals in your cart won't last! Complete your order & you'll be entered to win a $150 Gift Card!"; ?>
					
					<?php include_once("Browse/blocks/header.php"); ?>
					
          <?php include_once("Browse/devider.php"); ?>
				
					<?php include_once("Browse/cart_header_II.php"); ?>
