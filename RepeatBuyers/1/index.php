		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<!-- Intro --->
					<?php include_once("RepeatBuyers/1/1_1.php"); ?>
					
					<!-- Devider --->
					<?php include("RepeatBuyers/1/devider.php"); ?>
					
					
					<!-- Learn More--->					
				  <?php include_once("RepeatBuyers/1/1_2.php"); ?>
					<!-- Main Bullets--->
			    <?php include_once("RepeatBuyers/1/1_3.php"); ?>
					...
					<!-- Products Header--->
					<?php include_once("RepeatBuyers/1/1_7.php"); ?>
					<!-- Devider --->
					<?php include("RepeatBuyers/1/devider.php"); ?>
					<!-- Featured Products --->
					<?php include_once("RepeatBuyers/1/1_8.php"); ?>		
