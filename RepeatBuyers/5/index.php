...
<body style="min-width: 100%; padding: 0; margin: 0; -webkit-text-size-adjust: none; background-color: #e3e3e3;">
	<p style="display:none;">
		...
		<?php include_once("RepeatBuyers/blocks/style_2b.php"); ?>		
		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<!-- Intro --->
					<?php include_once("RepeatBuyers/5/5_1.php"); ?>
					<!-- Learn More--->
					<?php include_once("RepeatBuyers/5/5_2.php"); ?>
					<!-- Main banner--->
					<?php include_once("RepeatBuyers/5/5_3.php"); ?>
					<!-- Content Menu --->
					<?php include_once("RepeatBuyers/5/5_4.php"); ?>
					<!-- --->
					<?php include_once("RepeatBuyers/5/5_5.php"); ?>
					<!-- Directions --->
					<?php include_once("RepeatBuyers/5/5_6.php"); ?>
					<!-- Featured Products Header--->
					<?php include_once("RepeatBuyers/5/5_7.php"); ?>
					<!-- Featured Products --->
					<?php include_once("RepeatBuyers/5/5_8.php"); ?>
