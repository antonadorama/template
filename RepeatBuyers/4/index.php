		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php include_once("RepeatBuyers/4/4_1.php"); ?>
					
					<?php include_once("RepeatBuyers/4/4_2.php"); ?>
					
					<?php include_once("RepeatBuyers/4/4_3.php"); ?>
					
					<?php include_once("RepeatBuyers/4/4_4.php"); ?>
					
					<?php include_once("RepeatBuyers/4/4_5.php"); ?>
					
					<?php include_once("RepeatBuyers/4/4_6.php"); ?>
					
					<?php include_once("RepeatBuyers/4/4_8.php"); ?>
