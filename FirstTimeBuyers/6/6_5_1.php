      ...
      <tr>
        <td style="background-color: #e3e3e3;" class="vb-outer" align="center" bgcolor="#E3E3E3" valign="top">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;border-spacing: 9px;padding: 20px;width: 100%;max-width: 640px;background-color: #006E95;" 
                   class="vb-container halfpad" bgcolor="#006E95" border="0" cellpadding="0" cellspacing="20" width="570">
              <tbody>
                <tr>
                  <td style="background-color: #006E95; font-size: 24px; font-family: 'Montserrat', Helvetica, sans-serif; font-weight:700; 
                             color: #C3DEE8; text-align: center; letter-spacing:1px;" align="center" bgcolor="#006E95">PAST EVENTS</td>
                </tr>
              </tbody>
            </table>
          </div>
