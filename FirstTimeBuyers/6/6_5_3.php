    ...
    <tbody>
      <tr>
        <td class="vb-outer" align="center" valign="top" style="">
          <!--[if (gte mso 9)|(lte ie 8)]><table align="center" border="0" cellspacing="0" cellpadding="0" width="640"><tr>
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #000000;" 
                   class="vb-container fullwidth" align="center" bgcolor="#000000" border="0" cellpadding="0" cellspacing="18" width="640">
              <tbody>
                <tr>
                  <td valign="top">
