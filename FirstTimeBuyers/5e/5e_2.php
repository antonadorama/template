              ...
              <tr>
                ...
                <tr>
                  <td align="center"><!-- Feature Headline -->
                    ...
                    <table style="border-collapse: separate;border-spacing: 0px;padding: 0px;width: 58%;max-width: 600px;" class="vb-container halfpad" border="0" cellpadding="0" cellspacing="0" width="600">
                      <tbody>
                        <tr>
                          <td style="font-size: 31px; font-family: 'Montserrat', Helvetica, sans-serif; font-weight:700; color: #006E95; text-align: center; letter-spacing:1px; line-height:42px" align="center" class="big-title">
                            Discover Resources, In-Depth Knowledge and Product Support for Professionals.</span></td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #FFFFFF; 
                            ...
                            <a href="http://www.adorama.com/pro?emailprice=t&utm_source=slgt&utm_medium=email&utm_content=Body&utm_campaign=<?php echo $utm;?>" linkname="AdoramaPro" target="_new" style="text-decoration: none; color: #FFFFFF; font-weight: bold;">
                              LEARN MORE</a></td>
                        </tr>
                      </tbody>
                    </table></td>
