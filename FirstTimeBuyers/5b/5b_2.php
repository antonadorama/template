              ...
              <tr>
                ...
                <tr>
                  <td align="center"><!-- Feature Headline -->
                    ...
                    <table style="border-collapse: separate;border-spacing: 0px;padding: 0px;width: 70%;max-width: 600px;" class="vb-container halfpad" border="0" cellpadding="0" cellspacing="0" width="600">
                      <tbody>
                        <tr>
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="640"><tr><td align="center" valign="top"><![endif]-->
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #EAF3F7;" class="vb-container fullwidth" align="center" bgcolor="#EAF3F7" border="0" cellpadding="18" cellspacing="0" width="640">
              <tbody>
                <tr>
                  <td valign="top">
                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #FFFFFF; 
                            ...
                            <a  linkname="CamerasBody"   href="https://www.adorama.com/pages/usedQuote?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Trade&utm_content=Body&utm_campaign=<?php echo $utm;?>" linkname="Cameras" target="_new" style="text-decoration: none; color: #FFFFFF; font-weight: bold;">
                              GET A QUOTE</a></td>
                        </tr>
                      </tbody>
                    </table></td>
