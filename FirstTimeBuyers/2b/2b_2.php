                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #FFFFFF; 
                            ...
                            <a  rilt="CamerasBody"   href="https://www.adorama.com/c/Lenses?emailprice=t&utm_source=slgt&refby=slgt&utm_medium=email&guid=##GUID##&utm_term=Lenses&utm_content=Body&utm_campaign=<?php echo $utm;?>" linkname="Cameras" target="_new" style="text-decoration: none; color: #FFFFFF; font-weight: bold;">
                              SHOP LENSES</a></td>
                        </tr>
                      </tbody>
                    </table></td>
