		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $ttl = "Enjoying Your New Gear? We Selected These Special Offers To Make Your Gear Even Sweeter!"; ?>
					...
					<?php include_once("FirstTimeBuyers/4/4_8_1_d.php"); ?>
					
					<!-- Featured Products 2 Row--->
					<?php // include_once("FirstTimeBuyers/4/4_8_2.php"); ?>
					<?php include_once("FirstTimeBuyers/4/4_8_2_d.php"); ?>
