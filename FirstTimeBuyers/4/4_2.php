              ...
              <tr>
                ...
                <tr>
                  <td style="text-align: center; font-size: 21px; font-family: 'Arvo', Helvetica, sans-serif; font-weight:400italic;color: #006E95; line-height:26px;" class="small-title" align="center">
                    <em>Out with the Old, In with the New!</em></td>
                </tr>
                <tr>
                  <td height="18">&nbsp;</td>
              </tr>
                <tr>
                  <td align="center"><!-- Feature Headline -->
                    ...
                    <table style="border-collapse: separate;border-spacing: 0px;padding: 0px;width: 90%;max-width: 600px;" class="vb-container halfpad" border="0" cellpadding="0" cellspacing="0" width="600">
                      <tbody>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #FFFFFF; 
                            ...
                            <a  href="https://www.adorama.com/pages/usedQuote?emailprice=t&utm_source=slgt&utm_medium=email&utm_content=Body&utm_campaign=<?php echo $utm;?>" linkname="LearnMore" target="_new"                               
