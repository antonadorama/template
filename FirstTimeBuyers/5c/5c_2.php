                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 31px; font-family: 'Montserrat', Helvetica, sans-serif; font-weight:700; color: #006E95; text-align: center; letter-spacing:1px; line-height:42px" align="center" class="big-title">
                            Showcase Your Work Printed on the Finest Quality Photo Books and Prints</span></td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #FFFFFF; 
                            ...
                            <a  linkname="AdoramaPix"   href="https://www.adoramapix.com/app/home/?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=AdoramaPix&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_new" style="text-decoration: none; color: #FFFFFF; font-weight: bold;">
                              START PRINTING</a></td>
                        </tr>
                      </tbody>
                    </table></td>
