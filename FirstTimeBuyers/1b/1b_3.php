      ...
      <tr>
        <td class="vb-outer" align="center" valign="top" style="">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #EAF3FA;" class="vb-container fullwidth" align="center" bgcolor="#EAF3FA" border="0" cellpadding="18" cellspacing="0" width="770">
              <tbody>
                <tr>
                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #FFFFFF; font-weight: normal; padding:14px 24px; background-color: #F05674; border-radius: 0px; letter-spacing:1px;" height="26" align="center" bgcolor="#F05674" valign="middle" width="auto">
                            <a  rilt="Events" href="http://www.adorama.com/alc/events/" linkname="Events" target="_new" style="text-decoration: none; color: #FFFFFF; font-weight: bold;">LEARN MORE</a></td>
                        </tr>
                      </tbody>
                    </table></td>
                </tr>
