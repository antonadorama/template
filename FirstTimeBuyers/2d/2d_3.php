              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/c/Professional-Audio?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=ProAudio&utm_content=Body&utm_campaign=<?php echo $utm;?>" linkname="ProAudio" target="_blank">
                    <img src="http://www.adorama.com/col/images/email/adorama-rb-Image-2-4-feature-audio.jpg" 
                         style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" 
                         class="mobile-full" alt="Pro Audio" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
