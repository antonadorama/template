		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $ttl = "Shop Pro Audio Equipment Selected By Adorama Pro's"; ?>
					
					<?php include_once("FirstTimeBuyers/blocks/header.php"); ?>
					
					<!-- Intro --->
					<?php include_once("FirstTimeBuyers/2d/2d_1.php"); ?>
					<!-- Learn More--->
				  <?php include_once("FirstTimeBuyers/2d/2d_2.php"); ?>
					<!-- Main banner--->
			    <?php include_once("FirstTimeBuyers/2d/2d_3.php"); ?>
					
					<!-- First Row Products --->
					<?php include_once("FirstTimeBuyers/2d/2d_4.php"); ?>
					<!-- Second Row Products --->
					<?php include_once("FirstTimeBuyers/2d/2d_5.php"); ?>
					
					<!-- Products Header--->
					<?php include_once("FirstTimeBuyers/2d/2d_7.php"); ?>
					<!-- Featured Products --->
					<?php include_once("FirstTimeBuyers/2d/2d_8.php"); ?>		
