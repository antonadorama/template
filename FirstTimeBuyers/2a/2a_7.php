        ...
        <td style="background-color: #e3e3e3;" class="vb-outer" align="center" bgcolor="#E3E3E3" valign="top">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;border-spacing: 9px;padding: 20px;width: 100%;max-width: 640px;background-color: #DFEDF4;" class="vb-container halfpad" bgcolor="#DFEDF4" border="0" cellpadding="0" cellspacing="20" width="570">
              <tbody>
                <tr>
                  <td style="background-color: #DFEDF4; font-size: 24px; font-family: 'Montserrat', Helvetica, sans-serif; font-weight:700; color: #006E95; text-align: center; letter-spacing:1px;" align="center" bgcolor="#EAF3F7">
