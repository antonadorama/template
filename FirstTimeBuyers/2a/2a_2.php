                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 31px; font-family: 'Montserrat', Helvetica, sans-serif; font-weight:700; color: #006E95; text-align: center; letter-spacing:1px; line-height:42px" align="center" class="big-title">
                            From Point &#38; Shoot to HDSLR Cameras &ndash; <span style="white-space:nowrap;">We Have it All</span></td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; text-align: center; color: #FFFFFF; 
                            ...
                            <a  rilt="CamerasBody"   href="https://www.adorama.com/c/Cameras?emailprice=t&utm_source=slgt&refby=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=Cameras&utm_content=Body&utm_campaign=<?php echo $utm;?>" linkname="Cameras" target="_new" 
