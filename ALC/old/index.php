		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $ttl = "Also: Portrait Photography and Children, Faking Sunflare, and more!"; ?>
					
					<?php include_once("ALC/blocks/preheader.php"); ?>
					<?php include_once("ALC/blocks/header_alc.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("ALC/old/p_1.php"); ?>
					
					<?php include_once("ALC/old/p_2.php"); ?>
					
					<?php include_once("ALC/old/p_3.php"); ?>
