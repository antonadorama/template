<?php 
	...
	$article4 = array(
		...
		"link" => "https://www.adorama.com/alc/best-drones-with-cameras",
		"title" => "",
		"title_bottom" => "Best Drones with Cameras",
		"alt" => "Best Drones with Cameras",
		"title_linkname" => "V_ALC_Best_Drones_Title",
		"title_linkname_bottom" => "V_ALC_Best_Drones_Title_Bottom",
		"image" => "1637/alc_drones.jpg",
		"image_linkname" => "V_ALC_Best_Drones_Image",
		"see_more_linkname" => "V_ALC_Best_Drones_See_More"
