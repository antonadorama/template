...
<body style="min-width: 100%; padding: 0; margin: 0; -webkit-text-size-adjust: none; background-color: #e3e3e3;">
	<p style="display:none;">
		...
		<?php include_once("ALC/blocks/style_5.php"); ?>
		<?php //include_once("ALC/blocks/old_alc.php"); ?>
		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php //include_once("ALC/blocks/send_button.php"); ?>
					
					<?php $utm = "ALC_Email_060717"; ?>
					
					<?php $ttl = "Also: Choosing The Perfect Travel Lens, Best 360 Cameras, and more!"; ?>
					
					<?php include_once("ALC/blocks/preheader.php"); ?>
					<?php include_once("ALC/blocks/header_alc.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("ALC/alc060717/p_1.php"); ?>
					
					<?php include_once("ALC/alc060717/p_2.php"); ?>
					
					<?php include_once("ALC/alc060717/p_3.php"); ?>
					
					<?php include_once("ALC/alc060717/p_4.php"); ?>
					
					<?php include_once("ALC/alc060717/p_5.php"); ?>
