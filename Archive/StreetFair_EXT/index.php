		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Street_Fair_EXT_061617"; ?>
					
					<?php $ttl = "Don't miss out on these special savings. Shop now! "; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
			
					<?php include_once("Other/StreetFair_EXT/p_1.php"); ?>
					
					<?php include_once("Other/StreetFair_EXT/p_2.php"); ?>
					
					<?php include_once("Other/StreetFair_EXT/p_3.php"); ?>
					
					<?php include_once("Other/StreetFair_EXT/p_4.php"); ?>
