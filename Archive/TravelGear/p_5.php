              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/alc/on-assignment-with-dorie-hagler-why-i-added-the-sony-a7rii-to-my-gear-bag?emailprice=t&utm_source=slgt&utm_medium=email&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="Travel_Tip_2">
                    <img src="image_library/org_1/1578/eMail_Postcard-TravelGear_GuideSale_05.jpg" 
                         style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Travel Tip 2" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
