		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_4thJuly_BS_12_070417"; ?>
					...
					<?php include_once("Other/4thBS12/p_2.php"); ?>
					<?php include_once("Other/4thBS12/p_3.php"); ?>
					<?php include_once("Other/4thBS12/p_4.php"); ?>
					<?php include_once("Other/4thBS12/p_5.php"); ?>
					<?php include_once("Other/4thBS12/p_6.php"); ?>
