		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailJordanSmith"; ?>
					
					<?php $ttl = "Jordan Smith Workshop"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("Other/JordanSmith/p1.php"); ?>
					
					<?php include_once("Other/JordanSmith/p2.php"); ?>
					
					<?php include_once("Other/JordanSmith/p3.php"); ?>
					
					<?php include_once("Other/JordanSmith/p4.php"); ?>
					
					<?php include_once("Other/JordanSmith/p5.php"); ?>
					
					<?php include_once("Other/JordanSmith/p6.php"); ?>
