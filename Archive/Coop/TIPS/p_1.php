              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="mailto:edu@adorama.com?Subject=Quote Request" target="_blank" 
                       linkname="TIPS_Banner">
                    <img src="image_library/org_1/1646/COMP-eMail_Postcard_v2-Cooperatives_01-TIPSTAPS.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="TIPS Banner" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
