		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_4thJuly_Preview_Ext2_070217"; ?>
					
					<?php $ttl = "Don’t Miss Weekend-Only Savings from DJI, Apple, Canon, Nest & More!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					
					<?php include_once("Other/4thExt2/countdown.php"); ?>
		
					<?php include_once("Other/4thExt2/p_1.php"); ?>
					
					<?php include_once("Other/4thExt2/p_2.php"); ?>
