		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_BirthDay_ThankYou"; ?>
					
					<?php $ttl = "Dear Customer, our Birthday is here. And we wanted to share this gift with you to celebrate."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/ThankYouBD/p_1.php"); ?>
