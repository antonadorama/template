		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Street_Fair_061117"; ?>
					
					<?php $ttl = "EXCLUSIVE! | Grab Dozens of Exclusive Street Fair Specials to Celebrate our Annual NYC Street Fair!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
			
					<?php include_once("Other/StreetFair/p_1.php"); ?>
					
					<?php include_once("Other/StreetFair/p_2.php"); ?>
					
					<?php include_once("Other/StreetFair/p_3.php"); ?>
					
					<?php include_once("Other/StreetFair/p_4.php"); ?>
					
					<?php include_once("Other/StreetFair/p_5.php"); ?>
					
					<?php include_once("Other/StreetFair/p_6.php"); ?>
					
					<?php include_once("Other/StreetFair/p_7.php"); ?>
