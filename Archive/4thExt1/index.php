		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_4thJuly_Preview_Ext1_070117"; ?>
					
					<?php $ttl = "+  Shop New July Rebates on Cameras & Lenses!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					
					<?php include_once("Other/4thExt1/countdown.php"); ?>
		
					<?php include_once("Other/4thExt1/p_1.php"); ?>
					
					<?php include_once("Other/4thExt1/p_2.php"); ?>
