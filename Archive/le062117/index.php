		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Law_Enf_062117"; ?>
					
					<?php $ttl = "Products from Vortex Optics, Pelican and Bushnell at booth #920"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
			
					<?php include_once("Other/le062117/p_1.php"); ?>
					
					<?php include_once("Other/le062117/heads.php"); ?>
