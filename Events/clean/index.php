...
<body style="min-width: 100%; padding: 0; margin: 0; -webkit-text-size-adjust: none; background-color: #e3e3e3;">
	<p style="display:none;">
		...
		<?php include_once("Events/blocks/style.php"); ?>
		<?php include_once("Events/blocks/style_520.php"); ?>
    <?php include_once("Events/blocks/style_450.php"); ?>
		<?php include_once("Events/blocks/style_400.php"); ?>
		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php include_once("Events/blocks/header.php"); ?>
					
					
					<?php include_once("Events/blocks/footer.php"); ?>
				</tbody>
			</table>
			</td>
		</tr>
