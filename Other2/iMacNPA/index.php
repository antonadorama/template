		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_iMacProNPA_122017"; ?>
					
					<?php $ttl = "Let Apple's new iMac Pro turn big ideas into great work | Special financing available"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
	
					<?php include_once("Other/iMacNPA/p_1.php"); ?>
					
				<?php include_once("Other/iMacNPA/p_2.php"); ?>
