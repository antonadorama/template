		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailEvents171214"; ?>
					
					<?php $ttl = "Plus, Exclusive Hasselblad Offer, Green Monday Sale & Apple Deals Inside."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/StoreEvents_121417/p_1.php"); ?>
					
								
					<?php include_once("Other/StoreEvents_121417/e_2.php"); ?>
					
					<?php include_once("Other/StoreEvents_121417/e_3.php"); ?>
					
					<?php include_once("Other/StoreEvents_121417/e_4.php"); ?>
					
					<?php include_once("Other/StoreEvents_121417/e_5.php"); ?>
					
					<?php include_once("Other/StoreEvents_121417/p_2.php"); ?>
					
					<?php include("Other/StoreEvents_121417/devider.php"); ?>
					
					<?php include_once("Other/StoreEvents_121417/p_3.php"); ?>
					
					<?php include("Other/StoreEvents_121417/devider.php"); ?>
					
					<?php include_once("Other/StoreEvents_121417/p_4.php"); ?>
