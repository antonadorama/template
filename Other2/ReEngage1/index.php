		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailReEngageI_ReEng1"; ?>
					
					<?php $ttl = "Grab This Month's Best Deals on TV's, Computers, Tablets, Cameras, Lenses and More!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
          <?php include_once("Other/ReEngage1/p_1.php"); ?>
          <?php include_once("Other/ReEngage1/p_2.php"); ?>
