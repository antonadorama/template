		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_48HoursSale_011118"; ?>
					
					<?php $ttl = "Shop this limited time offer on our best products | Offer ends in 48 hours"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/48HoursSale/countdown.php"); ?>
					
					<?php include_once("Other/48HoursSale/p_1.php"); ?>
					
					<?php include_once("Other/48HoursSale/p_2.php"); ?>
					
					<?php include_once("Other/48HoursSale/p_3.php"); ?>
