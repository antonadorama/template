		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_GiftBundles_120517"; ?>
					
					<?php $ttl = "Give the Gift of Photography with Starter Camera,  Lens & Accessory Bundles, Now on Sale!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("Other/GiftBundle/p_1.php"); ?>  
