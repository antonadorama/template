		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_JanuaryRebates_Category_010718"; ?>
					
					<?php $ttl = "New Rebates Just In! | Check out these New Arrivals and Fresh Deals of the month!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					

					<?php include_once("Other/JanuaryRebates/Cats/p_1.php"); ?>
					<?php include_once("Other/JanuaryRebates/Cats/p_2.php"); ?>
					<?php include_once("Other/JanuaryRebates/Cats/p_3.php"); ?>
					<?php include_once("Other/JanuaryRebates/Cats/p_4.php"); ?>
					
					
					<?php include_once("Other/JanuaryRebates/Default/devider.php"); ?>
					
					<?php include_once("Other/JanuaryRebates/Default/p_2.php"); ?>
