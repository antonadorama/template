		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Canon_XA_NPA_120517"; ?>
					...
					<!-- Main Banner--->
					<?php include_once("Other/XANPA/p_1.php"); ?>  
					<?php include_once("Other/XANPA/p_2.php"); ?>  
					<?php include_once("Other/XANPA/p_3.php"); ?>  
					<?php include_once("Other/XANPA/p_4.php"); ?>  
					<?php include_once("Other/XANPA/p_5.php"); ?>  
					<?php include_once("Other/XANPA/p_6.php"); ?>  
