		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_D850_Accessories_091617"; ?>
					
					<?php $ttl = "Check Out These Nikon D850 Accessories While You Excitedly Wait For Your D850 Camera!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
		
					<?php include_once("Other/D850Acc/p_1.php"); ?>
														
					<?php include_once("Other/D850Acc/p_2.php"); ?>
					
					<?php include_once("Other/D850Acc/p_3.php"); ?>
					
					<?php include_once("Other/D850Acc/p_4.php"); ?>
					
					<?php include_once("Other/D850Acc/p_5.php"); ?>
					
					<?php include_once("Other/D850Acc/p_6.php"); ?>
