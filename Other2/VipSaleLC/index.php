		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_VipSaleLC_041418"; ?>
					
					<?php $ttl = "Don't miss our VIP sale!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
															
					<?php include_once("Other/VipSaleLC/p_1.php"); ?>
					<?php include_once("Other/VipSaleLC/p_2.php"); ?>
					<?php include_once("Other/VipSaleLC/p_3.php"); ?>				
					<?php include_once("Other/VipSaleLC/p_4.php"); ?>	
					<?php include_once("Other/VipSaleLC/p_5.php"); ?>
