		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php //$utm = "Email_SuperSale_4Products_012518"; ?>
					<?php $utm = "Email_SuperSale_Postcard_012518"; ?>
					
					<?php $ttl = "Shop our Super SALE now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/SuperSale/p_1.php"); ?>
					
					<?php //include_once("Other/SuperSale/p_2.php"); ?>	
					<?php //include_once("Other/SuperSale/p_3.php"); ?>	<!-- 6 -->
					<?php //include_once("Other/SuperSale/p_4.php"); ?>	
					<?php //include_once("Other/SuperSale/p_5.php"); ?>
					<?php //include_once("Other/SuperSale/p_6.php"); ?><!-- 4 -->
					<?php //include_once("Other/SuperSale/p_7.php"); ?>
					<?php //include_once("Other/SuperSale/p_8.php"); ?><!-- 6 -->
					<?php //include_once("Other/SuperSale/p_9.php"); ?><!-- 8 -->
					<?php //include_once("Other/SuperSale/p_10.php"); ?><!-- 8 -->
					<?php //include_once("Other/SuperSale/p_11.php"); ?><!-- 8 -->
					<?php //include_once("Other/SuperSale/p_12.php"); ?><!-- 8 -->
					<?php //include_once("Other/SuperSale/p_13.php"); ?><!-- 4 -->
					
					<?php include_once("Other/SuperSale/p_14.php"); ?>
					<?php include_once("Other/SuperSale/p_15.php"); ?>
					<?php include_once("Other/SuperSale/p_15_2.php"); ?>
					<?php include_once("Other/SuperSale/p_16.php"); ?>
					<?php include_once("Other/SuperSale/p_17.php"); ?>					
