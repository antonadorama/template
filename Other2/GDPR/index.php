		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_GDPR_052418"; ?>
					
					<?php $ttl = "TTL"; ?>
					
					<?php include_once("Other/blocks/naked_header.php"); ?>					
		
					<?php include_once("Other/GDPR/p_1.php"); ?>		

					<?php include_once("Other/blocks/naked_footer.php"); ?>
