		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_48_Hour_Sale_081717"; ?>
					
					<?php $ttl = "You Have an Exclusive 48 Hours to Grab Up To 60% OFF Top Gear!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/FlashSale_0817/countdown.php"); ?>
		
					<?php include_once("Other/FlashSale_0817/p_1.php"); ?>
					
					<?php include_once("Other/FlashSale_0817/devider.php"); ?>
					
					<?php include_once("Other/FlashSale_0817/p_2.php"); ?>
