		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_JanuaryRebates_012918"; ?>
					
					<?php $ttl = "Check out This Months Rebates Now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
	
					<?php include_once("Other/JanRebates/p_1.php"); ?>
					<?php include_once("Other/JanRebates/p_2.php"); ?>
					<?php include_once("Other/JanRebates/p_3.php"); ?>
					<?php include_once("Other/JanRebates/p_4.php"); ?>
					<?php include_once("Other/JanRebates/p_5.php"); ?>
					<?php include_once("Other/JanRebates/p_6.php"); ?>	
					<?php include_once("Other/JanRebates/p_7.php"); ?>
					<?php include_once("Other/JanRebates/p_8.php"); ?>
