		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Forensics_113017"; ?>
					
					<?php $ttl = "Shop our picks for point and shoot digital cameras"; ?>
					
					<?php // include_once("Other/blocks/header.php"); ?>
					<?php include_once("ABS/blocks/header.php"); ?>
					
					<?php include_once("Other/Forensics_113017/p_1.php"); ?>
					
					
					
					<?php include_once("Other/Forensics_113017/p_3.php"); ?>			
					
					<?php include_once("Other/Forensics_113017/p_2.php"); ?>
