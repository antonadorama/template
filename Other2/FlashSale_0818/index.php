		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_48_Hour_Sale_LC_081817"; ?>
					
					<?php $ttl = "You Have 24 Hours Left to Grab Up To 60% OFF Top Gear!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/FlashSale_0818/countdown.php"); ?>
		
					<?php include_once("Other/FlashSale_0818/p_1.php"); ?>
					
					<?php include_once("Other/FlashSale_0818/devider.php"); ?>
					
					<?php include_once("Other/FlashSale_0818/p_3.php"); ?>
					
					<?php include_once("Other/FlashSale_0818/devider.php"); ?>
					
					<?php include_once("Other/FlashSale_0818/p_2.php"); ?>
