		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_MidSummer_Sale_Nikon"; ?>
					
					<?php $ttl = "Save up to 58% - Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/MidSummerNikon/p_1.php"); ?>
					
					<?php include_once("Other/MidSummerNikon/p_2.php"); ?>	
