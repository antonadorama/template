		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $ttl = "Shop Profoto Deals at Adorama"; ?>
					
					<?php include_once("Other/blocks/3header.php"); ?>			
							
					<?php include_once("Other/ThirdPartyTemplate/p_1.php"); ?>	
					
					<?php include_once("Other/ThirdPartyTemplate/p_2.php"); ?>	
					
					<?php include_once("Other/ThirdPartyTemplate/p_3.php"); ?>	
					
					<?php include_once("Other/ThirdPartyTemplate/p_4.php"); ?>	
					
					<?php include_once("Other/ThirdPartyTemplate/p_5.php"); ?>
					
					<?php include_once("Other/ThirdPartyTemplate/p_6.php"); ?>
					
					<?php include_once("Other/blocks/3footer.php"); ?>
