		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Canon_4K_Video_120617"; ?>
					
					<?php $ttl = "Plus, Maximize Your Canon 4K Video Purchases with Special Financing Available!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("Other/Canon4K/p_1.php"); ?>

					
					
	<?php include_once("Other/Canon4K/p_2.php"); ?>
					
						<?php include_once("Other/Canon4K/p_3.php"); ?>
