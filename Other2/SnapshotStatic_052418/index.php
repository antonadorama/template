		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_SnapshotStatic_052518"; ?>
					
					<?php $ttl = "Get 15% off the Sachtler 1001 3-section Aluminum Tripod w/Medium Camporter Camera Bag. Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					


					
					<?php include_once("Other/SnapshotStatic_052418/p_1.php"); ?>
