		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_OneDaySale_c_080117"; ?>
					
					<?php $ttl = "You're invited to our Private Sale for exclusive savings of up to 77% off - Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/OneDay080117/countdown.php"); ?>	
					
					<?php include_once("Other/OneDay080117/p_1.php"); ?>	
					
					<?php include_once("Other/OneDay080117/p_2.php"); ?>					
