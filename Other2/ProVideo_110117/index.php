		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_ProVideo_110117"; ?>
					
					<?php $ttl = "Learn more about videography here! Don't forget to gear up too - Shop now!"; ?>
					
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/ProVideo_110117/p_1.php"); ?>	
					
					<?php include_once("Other/ProVideo_110117/p_2.php"); ?>		
					
					<?php include_once("Other/ProVideo_110117/p_3.php"); ?>					
					
					<?php include_once("Other/ProVideo_110117/p_4.php"); ?>
					
					<?php include_once("Other/ProVideo_110117/p_5.php"); ?>
					
					<?php include_once("Other/ProVideo_110117/p_6.php"); ?>					
					
					<?php include_once("Other/ProVideo_110117/p_7.php"); ?>
					
					<?php include_once("Other/ProVideo_110117/p_8.php"); ?>
					
					<?php include_once("Other/ProVideo_110117/p_9.php"); ?>
					
					<?php include_once("Other/ProVideo_110117/p_10.php"); ?>
