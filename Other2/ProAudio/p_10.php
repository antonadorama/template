              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.youtube.com/watch?v=ZitBGg9zGfg?emailprice=t&utm_source=slgt&refby=slgt&utm_medium=email&guid=##GUID##&utm_term=Shop&utm_content=Header&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="Do_You_Need_Acoustic_Treatment_For_Your_Home_Studio">
                    <img src="image_library/org_1/2095/Pro-Audio-Email-Body_13.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Do You Need Acoustic Treatment For Your Home Studio" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
