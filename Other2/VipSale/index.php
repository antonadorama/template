		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_VipSale_041318"; ?>
					
					<?php $ttl = "Don't miss our VIP sale!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					
											
					<?php include_once("Other/VipSale/p_1.php"); ?>
					<?php include_once("Other/VipSale/p_2.php"); ?>
					<?php include_once("Other/VipSale/p_3.php"); ?>
					<?php include_once("Other/VipSale/p_4.php"); ?>
					<?php include_once("Other/VipSale/p_5.php"); ?>
					
					<?php include_once("Other/VipSale/p_7.php"); ?>
					<?php include_once("Other/VipSale/p_6.php"); ?>
