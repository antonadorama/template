		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_FlashpointZoom_052418"; ?>
					
					<?php $ttl = "Advanced. Compact. Powerful. Order the Flashpoint Zoom Li-On Mini TTL R2 Flash for your Sony camera!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("Other/FlashpointZoom/p_1.php"); ?>
          <?php include_once("Other/FlashpointZoom/p_2.php"); ?>
          <?php include_once("Other/FlashpointZoom/p_3.php"); ?>
