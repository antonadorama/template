              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/g/vip-one-day-sale?emailprice=t&utm_source=slgt&refby=slgt&utm_medium=email&guid=##GUID##&utm_term=Shop&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="Main_Banner_Link">
                    <img src="image_library/org_1/2745/VIP-One-Day-Private-Sale-11-16-17_3.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
