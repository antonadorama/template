		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailVIPOneDayPrivateSale111717"; ?>
					
					<?php $ttl = "Unlock your VIP exclusive savings now + Early Black Friday, Holiday Deals & More!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
									
					
					<?php include_once("Other/OneDaySaleVIP_111717/p_1.php"); ?>
					
					<?php //include_once("Other/OneDaySaleVIP_111717/p_2.php"); ?>
					
					<?php include_once("Other/OneDaySaleVIP_111717/p_2_extra.php"); ?>
					
					<?php include_once("Other/HolidayLaunchMedium/p_7.php"); ?>
					
					<?php //include_once("Other/OneDaySaleVIP_111717/p_3.php"); ?>
					
					<?php include_once("Other/OneDaySaleVIP_111717/p_4.php"); ?>
