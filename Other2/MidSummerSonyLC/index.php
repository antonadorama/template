		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_MidSummer_Sale_Sony_LC_072517"; ?>
					
					<?php $ttl = "Catch up to 50% off - Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/MidSummerSony/p_1.php"); ?>	
					
				<?php include_once("Other/MidSummerSony/p_2.php"); ?>	
