                ...
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/?emailprice=t&utm_source=slgt&utm_medium=email&guid=##GUID##&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank"
                       linkname="DontLetPointsExpire">
                    <img src="image_library/org_1/4468/Adorama-Rewards-Lifecycle-Points-Expiring_01.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Dont Let Points Expire" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
		...
		<table style="font-size: 1.2em; font-family: Arial, Helvetica, sans-serif; color: #5e5e5e; text-align: center; 
          ...
          And once you've expired, they're lost.
           ...
           <hr width="40%" align="center" 
			...
			<tr align="center">
				<td style="padding-top:5px; padding-left:30px; padding-bottom:25px; padding-right:15px;">
          Log into your account and redeem your points at <br />
          checkout toward the best in pro photography, video, <br />
          audio and more!
				</td>
			</tr>
