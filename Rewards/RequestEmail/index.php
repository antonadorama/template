		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_RequestEmail"; ?>
					
					<?php $ttl = "Feed your passion for great gear and top value."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Rewards/RequestEmail/p_1.php"); ?>          
					...
					<?php include_once("Rewards/blocks/footer_annex.php"); ?>
