		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_NewOctoberRebatesCanon_100718"; ?>
					
					<?php $ttl = "We have new instant rebates for this October special!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php //include_once("Other/NewOctoberRebates/p_1.php"); ?>
          
          <?php //include_once("Other/NewOctoberRebates/p_1_nikon.php"); ?>
          <?php //include_once("Other/NewOctoberRebates/p_1_sony.php"); ?>
          <?php include_once("Other/NewOctoberRebates/p_1_canon.php"); ?>
          <?php //include_once("Other/NewOctoberRebates/p_1_panasonic.php"); ?>
          ...
          <?php include_once("Other/NewOctoberRebates/p_6.php"); ?>
          <?php include_once("Other/NewOctoberRebates/p_7.php"); ?>
          
          <?php //include_once("Other/NewOctoberRebates/p_8.php"); ?> <!--Sony-->
