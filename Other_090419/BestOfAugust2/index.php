		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_BestOfAugust2_083018"; ?>
					
					<?php $ttl = "Grab up to 40% off before it's gone!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/BestOfAugust2/p_1.php"); ?>
          
          <?php include_once("Other/BestOfAugust2/p_2.php"); ?>
          <?php include_once("Other/BestOfAugust2/p_3.php"); ?>
          <?php include_once("Other/BestOfAugust2/p_4.php"); ?>
          <?php include_once("Other/BestOfAugust2/p_5.php"); ?>
          <?php include_once("Other/BestOfAugust2/p_6.php"); ?>
          
          <?php include_once("Other/BestOfAugust2/p_7.php"); ?>
          <?php include_once("Other/BestOfAugust2/p_8.php"); ?>
          <?php include_once("Other/BestOfAugust2/p_9.php"); ?>
