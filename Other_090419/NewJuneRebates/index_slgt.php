...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_NewJuneRebates_060219"; ?>
					
					<?php $ttl = "Shop now for summer savings on your favorite brands!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/NewJuneRebates/p_1.php"); ?>
          <?php include_once("Other/NewJuneRebates/p_2.php"); ?>  
          <?php include_once("Other/NewJuneRebates/p_3.php"); ?> 
          <?php include_once("Other/NewJuneRebates/p_4.php"); ?> 
          <?php include_once("Other/NewJuneRebates/p_5.php"); ?>
          <?php include_once("Other/NewJuneRebates/p_6.php"); ?>
          <?php include_once("Other/NewJuneRebates/p_7.php"); ?> 
          <?php include_once("Other/NewJuneRebates/p_8.php"); ?> 
