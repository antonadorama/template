...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_EarthDay_042219"; ?>
					
					<?php $ttl = "Celebrate Earth Day with savings on eco-friendly products"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/EarthDay/p_1.php"); ?>

          <?php include_once("Other/EarthDay/p_3.php"); ?>
          
           <?php include_once("Other/EarthDay/p_2.php"); ?>
