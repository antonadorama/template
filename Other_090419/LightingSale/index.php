		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_LightingSale_082418"; ?>
					
					<?php $ttl = "Exclusively for You: Lighting Deals So Good, We Couldn't Wait Until Labor Day!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/LightingSale/p_1.php"); ?>
          <?php include_once("Other/LightingSale/p_2.php"); ?>
          <?php include_once("Other/LightingSale/p_3.php"); ?>
          <?php include_once("Other/LightingSale/p_4.php"); ?>
          <?php include_once("Other/LightingSale/p_5.php"); ?>
          <?php include_once("Other/LightingSale/p_6.php"); ?>
          <?php include_once("Other/LightingSale/p_7.php"); ?>
          <?php include_once("Other/LightingSale/p_8.php"); ?>
