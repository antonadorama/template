		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_EndOfSpringSale_061519"; ?>
					
					<?php $ttl = "End of Spring Warehouse Clearance // Shop huge markdowns and save!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/EndOfSpring/p_1.php"); ?>
          <?php include_once("Other/EndOfSpring/p_2.php"); ?>
          <?php include_once("Other/EndOfSpring/p_3.php"); ?>
          <?php include_once("Other/EndOfSpring/p_4.php"); ?>
          <?php include_once("Other/EndOfSpring/p_5.php"); ?>
