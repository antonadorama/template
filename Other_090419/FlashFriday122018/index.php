		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_FlashFriday_122118"; ?>
					
					<?php $ttl = "'Tis the season to enjoy our exclusive holiday flash deals - Shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/FlashFriday122018/p_1.php"); ?>
