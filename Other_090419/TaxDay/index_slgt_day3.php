...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_TaxDay_041519"; ?>
					
					<?php $ttl = "Don't miss these incredible Tax Day savings!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/TaxDay/p_15.php"); ?>
          <?php include_once("Other/TaxDay/p_16.php"); ?>
          <?php include_once("Other/TaxDay/p_17.php"); ?>
          <?php include_once("Other/TaxDay/p_18.php"); ?>
          <?php include_once("Other/TaxDay/p_19.php"); ?>
