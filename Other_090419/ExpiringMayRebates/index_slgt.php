...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_ExpiringMayRebates_053019"; ?>
					
					<?php $ttl = "May is ending, save now for summer with these instant rebates!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/ExpiringMayRebates/p_1.php"); ?>
          <?php include_once("Other/ExpiringMayRebates/p_2.php"); ?>  
          <?php include_once("Other/ExpiringMayRebates/p_3.php"); ?> 
          <?php include_once("Other/ExpiringMayRebates/p_4.php"); ?> 
          <?php include_once("Other/ExpiringMayRebates/p_5.php"); ?>
          <?php include_once("Other/ExpiringMayRebates/p_6.php"); ?>
          <?php include_once("Other/ExpiringMayRebates/p_7.php"); ?> 
          <?php include_once("Other/ExpiringMayRebates/p_8.php"); ?> 
