...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_AccessorySaleLCOptimail_040519"; ?>
					
					<?php $ttl = "Save up to 70% on gear for your camera before this deal ends!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/AccessorySale/p_1.php"); ?>
          
          <?php include_once("Other/AccessorySale/p_3.php"); ?>
          <?php include_once("Other/AccessorySale/p_4.php"); ?>
          <?php include_once("Other/AccessorySale/p_5.php"); ?>
          <?php include_once("Other/AccessorySale/p_6.php"); ?>
          <?php include_once("Other/AccessorySale/p_7.php"); ?>
          <?php include_once("Other/AccessorySale/p_8.php"); ?>
