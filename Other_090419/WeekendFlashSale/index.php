		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_WeekendFlashSaleLCCanon_082618"; ?>
					
					<?php $ttl = "Hours left until our Weekend Flash Sale goes dark!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		      
          <?php //include_once("Other/WeekendFlashSale/p_1.php"); ?>
					<?php //include_once("Other/WeekendFlashSale/p_1_apple.php"); ?>
          <?php //include_once("Other/WeekendFlashSale/p_1_sony.php"); ?>
          <?php //include_once("Other/WeekendFlashSale/p_1_nikon.php"); ?>
          <?php include_once("Other/WeekendFlashSale/p_1_canon.php"); ?>
          
          <?php //include_once("Other/WeekendFlashSale/p_1_browsedtop.php"); ?>
          <?php //include_once("Other/WeekendFlashSale/c.php"); ?>
          <?php //include_once("Other/WeekendFlashSale/p_1_browsebottom.php"); ?>
          
          
          <?php include_once("Other/WeekendFlashSale/p_3.php"); ?>
          <?php include_once("Other/WeekendFlashSale/p_2.php"); ?>
