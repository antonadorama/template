...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_MidSummerPriceDrop_072719"; ?>
					
					<?php $ttl = "Cool down with our Summer Savings!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/MidSummerPriceDrop19/p_1.php"); ?>

          <?php include_once("Other/MidSummerPriceDrop19/p_3.php"); ?>
          <?php include_once("Other/MidSummerPriceDrop19/p_4.php"); ?>
          <?php include_once("Other/MidSummerPriceDrop19/p_5.php"); ?>
          <?php include_once("Other/MidSummerPriceDrop19/p_6.php"); ?>
          <?php include_once("Other/MidSummerPriceDrop19/p_7.php"); ?>
          <?php include_once("Other/MidSummerPriceDrop19/p_8.php"); ?>
          
          <?php include_once("Other/MidSummerPriceDrop19/p_10.php"); ?>
          <?php include_once("Other/MidSummerPriceDrop19/p_11.php"); ?>
          <?php include_once("Other/MidSummerPriceDrop19/p_12.php"); ?>

         					
					<?php include_once("Other/PostHolidayTemplate/FeaturedBannerOptm_2.php"); ?>
					<?php include_once("Other/PostHolidayTemplate/4citerecs.php"); ?>							
					<?php include_once("Other/PostHolidayTemplate/spotlightOptm_2.php"); ?>						
