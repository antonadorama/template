		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Snapshot_090418"; ?>
					
					<?php $ttl = "Save 9% on Apple AirPods today with Adorama!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
          
					<?php include_once("Other/Snapshot_090418/snapshot_header.php"); ?>
					
					<?php //include_once("Other/SnapshotTemplate/p_1.php"); ?>
					
					<?php include_once("Other/Snapshot_090418/devider.php"); ?>
					
					<?php include_once("Other/Snapshot_090418/countdown_split.php"); ?>
									
					<?php include_once("Other/Snapshot_090418/snapshot.php"); ?>						
					
					<?php include_once("Other/Snapshot_090418/snapshot_footer.php"); ?>
                   
					
					<?php include_once("Other/PostHolidayTemplate/FeaturedBanner.php"); ?>
					<?php include_once("Other/PostHolidayTemplate/4citerecs.php"); ?>
					<?php include_once("Other/Snapshot_090418/spotlight.php"); ?>
