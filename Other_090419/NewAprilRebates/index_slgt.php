...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_NewAprilRebates_040719"; ?>
					
					<?php $ttl = "Save for spring with instant rebates on everything"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/NewAprilRebates/p_1.php"); ?>
          <?php include_once("Other/NewAprilRebates/p_2.php"); ?>
          
          <?php include_once("Other/NewAprilRebates/p_3.php"); ?>
          <?php include_once("Other/NewAprilRebates/p_4.php"); ?>
          <?php include_once("Other/NewAprilRebates/p_5.php"); ?>
          <?php include_once("Other/NewAprilRebates/p_6.php"); ?>
          <?php include_once("Other/NewAprilRebates/p_7.php"); ?>
          <?php include_once("Other/NewAprilRebates/p_8.php"); ?>
          
          <?php include_once("Other/NewAprilRebates/p_9.php"); ?>
