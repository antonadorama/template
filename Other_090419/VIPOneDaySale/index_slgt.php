...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_VIPOneDaySale_070119"; ?>
					
					<?php $ttl = "Shop our One Day Sale for up to 50% OFF!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/VIPOneDaySale/p_1.php"); ?>

          <?php include_once("Other/VIPOneDaySale/p_3.php"); ?>
          <?php include_once("Other/VIPOneDaySale/p_4.php"); ?>
          <?php include_once("Other/VIPOneDaySale/p_5.php"); ?>
          <?php include_once("Other/VIPOneDaySale/p_6.php"); ?>
          <?php include_once("Other/VIPOneDaySale/p_7.php"); ?>
          <?php include_once("Other/VIPOneDaySale/p_8.php"); ?>    
