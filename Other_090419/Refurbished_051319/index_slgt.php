...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_Refurbished_051319"; ?>
					
					<?php $ttl = "Refurbished Deals >> Save up to 50% on select items now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/Refurbished_051319/p_1.php"); ?>
          <?php include_once("Other/Refurbished_051319/p_2.php"); ?>
          <?php include_once("Other/Refurbished_051319/p_3.php"); ?>
          <?php include_once("Other/Refurbished_051319/p_4.php"); ?>
          <?php include_once("Other/Refurbished_051319/p_5.php"); ?>
          <?php include_once("Other/Refurbished_051319/p_6.php"); ?>
