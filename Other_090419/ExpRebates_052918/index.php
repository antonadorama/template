		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_ExpiringMayRebatesCategory_052918"; ?>
					
					<?php $ttl = "Save Hundreds On Our Top Brands Now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("Other/ExpRebates_052918/p_1.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_2.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_3.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_4.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_5.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_6.php"); ?>
          
          <?php include_once("Other/ExpRebates_052918/p_7.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_8.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_9.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_10.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_11.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_12.php"); ?>
          <?php include_once("Other/ExpRebates_052918/p_13.php"); ?>
