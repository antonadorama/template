		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_NikonPriceDrops_052918"; ?>
					
					<?php $ttl = "Save Hundreds On Nikon Before May Ends!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("Other/NikonPriceDrop/p_1.php"); ?>
          <?php include_once("Other/NikonPriceDrop/p_2.php"); ?>
          
          <?php include_once("Other/NikonPriceDrop/p_3.php"); ?>
          <?php include_once("Other/NikonPriceDrop/p_4.php"); ?>
          <?php include_once("Other/NikonPriceDrop/p_5.php"); ?>
          <?php include_once("Other/NikonPriceDrop/p_6.php"); ?>
          <?php include_once("Other/NikonPriceDrop/p_7.php"); ?>
          <?php include_once("Other/NikonPriceDrop/p_8.php"); ?>
          
          <?php include_once("Other/NikonPriceDrop/p_9.php"); ?>
          <?php include_once("Other/NikonPriceDrop/p_10.php"); ?>
