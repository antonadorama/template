		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_BestOfMay_053118"; ?>
					
					<?php $ttl = "Save Big On Our Best Sellers!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("Other/BestOfMay/p_1.php"); ?>
          <?php include_once("Other/BestOfMay/p_2.php"); ?>
          <?php include_once("Other/BestOfMay/p_3.php"); ?>
          <?php include_once("Other/BestOfMay/p_4.php"); ?>
