		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_NewNovemberRebates_Canon_110418"; ?>
					
					<?php $ttl = "Shop now to save on Canon!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php //include_once("Other/NewNovemberRebates/p_1.php"); ?>
          
          <?php //include_once("Other/NewNovemberRebates/p_1_nikon.php"); ?>
          <?php //include_once("Other/NewNovemberRebates/p_1_sony.php"); ?>
          <?php include_once("Other/NewNovemberRebates/p_1_canon.php"); ?>
          <?php //include_once("Other/NewNovemberRebates/p_1_panasonic.php"); ?>
          <?php //include_once("Other/NewNovemberRebates/p_1_fujifilm.php"); ?>
          
          <?php include_once("Other/NewNovemberRebates/p_2.php"); ?> 
          <?php include_once("Other/NewNovemberRebates/p_3.php"); ?>
          <?php include_once("Other/NewNovemberRebates/p_4.php"); ?>
          <?php include_once("Other/NewNovemberRebates/p_5.php"); ?>
          <?php include_once("Other/NewNovemberRebates/p_6.php"); ?>
          <?php include_once("Other/NewNovemberRebates/p_7.php"); ?>
          
          <?php include_once("Other/NewNovemberRebates/p_9.php"); ?> <!--Sony-->
