...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_MemorialDay3_052619"; ?>
					
					<?php $ttl = "Our Memorial Day Weekend Sale will be ending soon... Shop now to take advantage of these savings!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/MemorialDay4/p_7.php"); ?>
