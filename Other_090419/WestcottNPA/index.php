...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_WestcottNPA_100918"; ?>
          <?php $ttl = "Lighting Evolved featuring Flex Cine LED Mats, Wireless Smart DMX Dimmer, Portable Light Mounts & Modifiers and More!"; ?>

					<?php include_once("Other/blocks/header.php"); ?>		
          
					<?php include_once("Other/WestcottNPA/p_1.php"); ?>
          <?php include_once("Other/WestcottNPA/p_2.php"); ?>
          <?php include_once("Other/WestcottNPA/p_3.php"); ?>
