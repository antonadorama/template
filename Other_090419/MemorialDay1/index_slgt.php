...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_MemorialDay4_052419"; ?>
					
					<?php $ttl = "You're getting first dibs at our Memorial Day Weekend Event // Get ready to save up to 70%"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/MemorialDay1/p_1.php"); ?>  
