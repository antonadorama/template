		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_VIP360Sale_Fujifilm_101218"; ?>
					
					<?php $ttl = "Explore deals on Fujifilm and other great brands!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php //include_once("Other/VIP360Sale/p_1.php"); ?>
          
          <?php //include_once("Other/VIP360Sale/p_1_nikon.php"); ?>
          <?php //include_once("Other/VIP360Sale/p_1_canon.php"); ?>
          <?php //include_once("Other/VIP360Sale/p_1_sony.php"); ?>
          <?php //include_once("Other/VIP360Sale/p_1_panasonic.php"); ?>
          <?php include_once("Other/VIP360Sale/p_1_fujifilm.php"); ?>
          
          <?php include_once("Other/VIP360Sale/p_2.php"); ?>
          <?php include_once("Other/VIP360Sale/p_3.php"); ?>
          <?php include_once("Other/VIP360Sale/p_4.php"); ?>
          <?php include_once("Other/VIP360Sale/p_5.php"); ?>
          <?php include_once("Other/VIP360Sale/p_6.php"); ?>

          <?php include_once("Other/VIP360Sale/p_7.php"); ?>
          <?php include_once("Other/VIP360Sale/p_8.php"); ?>
          <?php include_once("Other/VIP360Sale/p_9.php"); ?>
          <?php include_once("Other/VIP360Sale/p_10.php"); ?>
