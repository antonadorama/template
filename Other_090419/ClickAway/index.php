		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_ClickAway_010919"; ?>
					
					<?php $ttl = "You've been selected to receive a free ticket to the 2019 CLICK AWAY event. Register now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<?php include_once("Other/ClickAway/p_1_browsed_1.php"); ?>
          <?php include_once("Other/ClickAway/p_1_browsed_2.php"); ?>
          <?php include_once("Other/ClickAway/p_1_browsed_3.php"); ?>
