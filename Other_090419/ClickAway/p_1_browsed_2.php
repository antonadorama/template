...
<td>
  <table id="ko_textBlock_4" style="background-color: #ffffff" class="vb-outer" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr>
        <td class="vb-outer" align="center" bgcolor="#ffffff" valign="top">
          ...
          <div class="oldwebkit" style="max-width: 640px;">
            <table style="border-collapse: separate;border-spacing: 0px;padding-left: 0;padding-right: 0;width: 100%;max-width: 640px;background-color: #fff;" 
              ...
              <tbody>
              <tr>
                  <td style="font-weight:bold; background-color: #ffffff font-size: 1.5em; font-family: Arial, Helvetica, sans-serif; 
                             color: #252525; text-align:center; padding-top:20px;padding-bottom:20px;" 
