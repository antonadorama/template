...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_WeekendWarehouseRefurbishedBrowsed_060918"; ?>
          <?php $ttl = "Save on ##SMFMT_PROPERCASE[\second_level_category]##. Shop now!"; ?>

					<?php include_once("Other/blocks/header.php"); ?>		
          
					<?php //include_once("Other/WeekendWarehouseRFB/p_1.php"); ?>
          
          <?php include_once("Other/WeekendWarehouseRFB/p_1_browsed_1.php"); ?>
          <?php include_once("Other/WeekendWarehouseRFB/p_1_browsed_2.php"); ?>
          <?php include_once("Other/WeekendWarehouseRFB/p_1_browsed_3.php"); ?>
                   
          
          <?php include_once("Other/WeekendWarehouseRFB/p_2.php"); ?>
          <?php include_once("Other/WeekendWarehouseRFB/p_3.php"); ?>
