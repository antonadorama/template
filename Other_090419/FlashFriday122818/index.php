		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_FlashFriday_122818"; ?>
					
					<?php $ttl = "Save big on ORLIT Lighting & Studio. Hurry, shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/FlashFriday122818/p_1.php"); ?>
          <?php include_once("Other/FlashFriday122818/p_2.php"); ?>
          <?php include_once("Other/FlashFriday122818/p_3.php"); ?>
          <?php include_once("Other/FlashFriday122818/p_4.php"); ?>          
          <?php include_once("Other/FlashFriday122818/p_5.php"); ?>
          <?php include_once("Other/FlashFriday122818/p_6.php"); ?>
          <?php include_once("Other/FlashFriday122818/p_7.php"); ?>
          <?php include_once("Other/FlashFriday122818/p_8.php"); ?>
