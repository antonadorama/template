...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_NationalCameraDay_062919"; ?>
					
					<?php $ttl = "These instant rebates are expiring soon, don't wait!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>   
          
          <?php include_once("Other/NationalCameraDay/p_1.php"); ?>
          <?php include_once("Other/NationalCameraDay/p_1_1.php"); ?>
          <?php include_once("Other/NationalCameraDay/p_2.php"); ?>  
          <?php include_once("Other/NationalCameraDay/p_3.php"); ?> 
          <?php include_once("Other/NationalCameraDay/p_4.php"); ?> 
          <?php include_once("Other/NationalCameraDay/p_5.php"); ?>
          <?php include_once("Other/NationalCameraDay/p_6.php"); ?>
          <?php include_once("Other/NationalCameraDay/p_7.php"); ?> 
          <?php include_once("Other/NationalCameraDay/p_8.php"); ?> 
