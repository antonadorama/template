		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_WeekendSummerSaleMain_062219"; ?>
					
					<?php $ttl = "It's time to save for summer on our best sellers"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
          <?php include_once("Other/WeekendSummerSale/p_1.php"); ?>
          <?php include_once("Other/WeekendSummerSale/p_2.php"); ?>
          
          <?php include_once("Other/WeekendSummerSale/p_3.php"); ?>
          <?php include_once("Other/WeekendSummerSale/p_4.php"); ?>
          <?php include_once("Other/WeekendSummerSale/p_5.php"); ?>
          <?php include_once("Other/WeekendSummerSale/p_6.php"); ?>
          <?php include_once("Other/WeekendSummerSale/p_7.php"); ?>
          <?php include_once("Other/WeekendSummerSale/p_8.php"); ?>
