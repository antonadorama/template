		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_PrivateSale24HoursLeft_120618"; ?>
					
					<?php $ttl = "Up to 47% off Lighting & Studio Gear is waiting... Hurry, shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/PrivateBrands24/p_1.php"); ?>
          <?php include_once("Other/PrivateBrands24/countdown.php"); ?>
          <?php include_once("Other/PrivateBrands24/p_2.php"); ?>
          <?php include_once("Other/PrivateBrands24/p_3.php"); ?>
