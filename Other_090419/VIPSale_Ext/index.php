		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_OneDayVIPSaleExtended_090818"; ?>
					
					<?php $ttl = "Don't miss one more day of deals. Hurry, shop now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/VIPSale_Ext/p_1.php"); ?>
          
          <?php include_once("Other/VIPSale_Ext/p_3.php"); ?>
          <?php include_once("Other/VIPSale_Ext/p_4.php"); ?>
          <?php include_once("Other/VIPSale_Ext/p_5.php"); ?>
          <?php include_once("Other/VIPSale_Ext/p_7.php"); ?>
          <?php include_once("Other/VIPSale_Ext/p_6.php"); ?>
