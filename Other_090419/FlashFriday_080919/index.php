...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_FlashFriday_080919"; ?>
					
					<?php $ttl = "Shop these one-day lightning deals to save on your favorite gear!"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>   
          
          <?php include_once("Other/FlashFriday_080919/p_1.php"); ?>
          <?php include_once("Other/FlashFriday_080919/p_2.php"); ?>
          <?php include_once("Other/FlashFriday_080919/p_3.php"); ?>
          <?php include_once("Other/FlashFriday_080919/p_4.php"); ?>
          <?php include_once("Other/FlashFriday_080919/p_5.php"); ?>
          <?php include_once("Other/FlashFriday_080919/p_6.php"); ?>
          <?php include_once("Other/FlashFriday_080919/p_7.php"); ?>
