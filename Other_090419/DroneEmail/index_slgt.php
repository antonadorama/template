		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_DroneEmail_031819"; ?>
					
					<?php $ttl = "Up To $300 Off Popular Drone Brands - shop now"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					
		
					<?php include_once("Other/DroneEmail/p_1.php"); ?>
          <?php include_once("Other/DroneEmail/p_2.php"); ?>
          <?php include_once("Other/DroneEmail/p_3.php"); ?>
          <?php include_once("Other/DroneEmail/p_4.php"); ?>
          <?php include_once("Other/DroneEmail/p_5.php"); ?>
