		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Trade_041019"; ?>
					
					<?php $ttl = "Get a quote on your gear now to earn up to 70% cash value"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/Trade041019/p_1.php"); ?>
          <?php include_once("TradeIn/Trade041019/p_2.php"); ?>		
