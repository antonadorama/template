		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Nikon_NPA_ABS_082417"; ?>
					...
					<!-- Main Banner--->
					<?php include_once("TradeIn/NikonNPA/p_1.php"); ?>
					
					<?php include_once("TradeIn/NikonNPA/p_2.php"); ?>
					
					<?php include_once("TradeIn/NikonNPA/p_3.php"); ?>
