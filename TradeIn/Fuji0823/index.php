		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TradeIn_Fuji_X_Series_082317"; ?>
					
					<?php $ttl = "Time to trade up your old Fujifilm X-Series Gear & get up to 70% credit towards the next generation version!"; ?>
					
					<?php include_once("TradeIn/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("TradeIn/Fuji0823/p_1.php"); ?>
