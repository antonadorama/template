		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailTrade121317"; ?>
					
					<?php $ttl = "Free Up Some Cash for New Gifts by Trading In Your Old Gear! Get a Quote Now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
				
					<?php include_once("TradeIn/Trade_121317/p_2.php"); ?>
