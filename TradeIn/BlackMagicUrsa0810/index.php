...
<body style="min-width: 100%; padding: 0; margin: 0; -webkit-text-size-adjust: none; background-color: #e3e3e3;">
	<p style="display:none;">
		...
		<?php include_once("TradeIn/blocks/style_4.php"); ?>		
		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_BlackmagicUrsa_081017"; ?>
					
					<?php $ttl = "Time to trade up your old Blackmagic Gear & get up to 70% credit towards the next generation version!"; ?>
					
					<?php include_once("TradeIn/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("TradeIn/BlackMagicUrsa0810/p_1.php"); ?>
          
					<?php include_once("TradeIn/BlackMagicUrsa0810/p_2.php"); ?>
