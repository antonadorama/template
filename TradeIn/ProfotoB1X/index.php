		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TradeIn_Profoto_B1X_061617"; ?>
					
					<?php $ttl = "Time to trade up your old Profoto gear & get up to 70% credit towards the latest Profoto B1X!"; ?>
					
					<?php include_once("TradeIn/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("TradeIn/ProfotoB1X/p_1.php"); ?>
					
					<?php include_once("TradeIn/ProfotoB1X/p_2.php"); ?>
