              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/g/sony-trade-up-2018?emailprice=t&utm_source=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=SonyTradeBanner&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="SonyTrade">
                    <img src="image_library/org_1/4125/sony_trade.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="SonyTrade" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
