              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/ilcqp.html?emailprice=t&utm_source=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=GetQuote&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="LeicaQPDigitalCamera">
                    <img src="image_library/global/Trade-Leica-Latest-Email-010319-v2_01.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Leica Q-P Digital Camera" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
