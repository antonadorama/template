		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_LeicaTrade_010819"; ?>
					
					<?php $ttl = "It's time to trade up... Contact us now."; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/Leica_010819/p_1.php"); ?>
          <?php include_once("TradeIn/Leica_010819/p_2.php"); ?>	
          <?php include_once("TradeIn/Leica_010819/p_3.php"); ?>	
          <?php include_once("TradeIn/Leica_010819/p_4.php"); ?>	
