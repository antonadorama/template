              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/g/nikon-bundle-blast-2018?emailprice=t&utm_source=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="NikonBundleBlast">
                    <img src="image_library/org_1/3781/eMail-Trade_Nikon_01.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Nikon Bundle Blast" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
