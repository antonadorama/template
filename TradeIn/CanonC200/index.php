		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TradeIn_Canon_C200_061517"; ?>
					
					<?php $ttl = "Time to trade up your old camera & get up to 70% credit towards the latest Canon C200!"; ?>
					
					<?php include_once("TradeIn/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("TradeIn/CanonC200/p_1.php"); ?>
					
					<?php include_once("TradeIn/CanonC200/p_2.php"); ?>
