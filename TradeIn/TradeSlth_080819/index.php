...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_Trade_080819"; ?>
					
					<?php $ttl = "Stay cool with some extra cash! Trade-in to earn up to 70% cash value"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>             

          <?php include_once("TradeIn/TradeSlth_080819/p_1.php"); ?>
          <?php include_once("TradeIn/TradeSlth_080819/devider.php"); ?>
          <?php include_once("TradeIn/TradeSlth_080819/p_2.php"); ?>
