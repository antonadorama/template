		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TradeIn_Sony_GM_072417"; ?>
					
					<?php $ttl = "Time to trade up your old Sony gear & get up to 70% credit towards latest Sony G Master Lenses!"; ?>
					
					<?php include_once("TradeIn/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("TradeIn/SonyGM/p_1.php"); ?>
	
					<?php include_once("TradeIn/SonyGM/p_2.php"); ?>
