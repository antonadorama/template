              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/searchsite/default.aspx?searchinfo=zeiss+cp.3&emailprice=t&utm_source=slgt&utm_medium=email&guid=##GUID##&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="D_FP_Zeiss_CP3">
                    <img src="image_library/org_1/1742/eMail_Postcard-Zeiss_CompactPrime_TradeIn_01.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Zeiss CP 3" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
