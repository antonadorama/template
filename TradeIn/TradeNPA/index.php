		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TradeGH5S_011518"; ?>
					
					<?php $ttl = "Time to trade up your old GH Panasonic Gear & get up to 70% credit towards the next generation version!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					

					<?php include_once("TradeIn/TradeNPA/p_1.php"); ?>
					<?php include_once("TradeIn/TradeNPA/p_2.php"); ?>			
