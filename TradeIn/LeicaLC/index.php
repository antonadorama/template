		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailTradeLeicaLC122617"; ?>
					
					<?php $ttl = "Time to trade up your old Leica Gear & get up to 70% credit towards the next generation version!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					
					<?php include_once("TradeIn/LeicaLC/p_1.php"); ?>
				
					<?php include_once("TradeIn/LeicaLC/p_2.php"); ?>
