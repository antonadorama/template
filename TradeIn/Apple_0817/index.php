		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TradeIn_Apple_081717"; ?>
					
					<?php $ttl = "Time to trade up your old Apple gear & get up to 70% credit towards Apple’s latest Macbooks & iMacs!"; ?>
					
					<?php include_once("TradeIn/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("TradeIn/Apple_0817/p_1.php"); ?>
	
					<?php include_once("TradeIn/Apple_0817/p_2.php"); ?>
