		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "EmailGoPro_031417"; ?>
					
					<?php $ttl = "Get a free GoPro 3-Way or GoPro Head Strap + QuickClip with the purchase of select GoPro Cameras. Shop Now!"; ?>
					
					<?php include_once("TradeIn/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("TradeIn/GoPro/p_1.php"); ?>
