		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_CanonTrade_062618"; ?>
					
					<?php $ttl = "Time to trade up your old Canon Gear & get up to 70% credit towards the next generation version!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					

					<?php include_once("TradeIn/CanonTrade_062618/p_1.php"); ?>
          <?php include_once("TradeIn/CanonTrade_062618/p_2.php"); ?>			
