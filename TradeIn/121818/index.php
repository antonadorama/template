		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Trade_121818"; ?>
					
					<?php $ttl = "Trade in your old gear for up to 70% cash value. Get a quote now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/121818/p_1.php"); ?>			
					<?php include_once("TradeIn/121818/p_2.php"); ?>						
