		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Trade_071119"; ?>
					
					<?php $ttl = "Earn up to 70% cash back when you trade in your gear!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/Trade_071119/p_1.php"); ?>

          <?php include_once("TradeIn/Trade_071119/p_2.php"); ?>		
