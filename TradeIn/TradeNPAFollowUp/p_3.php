                ...
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/l/Used/?sel=Condition_D_E-plus_N_E&emailprice=t&utm_source=slth&email={email}&utm_medium=email&guid={profile.vars.guid}&utm_term=UsedClearanceBanner&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       >
                    <img src="https://www.adorama.com/col/images/email/Optimail/TradeNPAFollowUp/NPA-Trade-up-Followup-MKT-26432-feature-banner.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
