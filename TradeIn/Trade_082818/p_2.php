                ...
                <tr>
                  <td align="center" valign="top">
                    <a href="https://www.adorama.com/l/Used/?sel=Condition_D_E-plus_N_E&emailprice=t&utm_source=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_term=UsedClearanceBanner&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="UsedSale">
                    <img src="image_library/org_1/4198/eMail_Feature-UsedClearance-Aug2.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
