		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TradeUp_Ricoh_120717"; ?>
					
					<?php $ttl = "We're Gifting You an Exclusive $100 Coupon + $50 Gift Card When You Trade Up to the New Ricoh Theta V!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					
					<!-- Main Banner--->
					<?php include_once("TradeIn/Ricoh_120717/p_1.php"); ?>
					<?php include_once("TradeIn/Ricoh_120717/p_2.php"); ?>
