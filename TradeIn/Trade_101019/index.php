...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_Trade_101019"; ?>
					
					<?php $ttl = "Trade in today for up to 70% cash back!"; ?>
					
					<?php include_once("Other/blocks/header_rebrand.php"); ?>             

          <?php include_once("TradeIn/Trade_101019/p_1.php"); ?>
          <?php include("TradeIn/Trade_092619/devider.php"); ?>
          <?php include_once("TradeIn/Trade_101019/p_2.php"); ?>
