		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_TradeProgram_TradeP"; ?>
					
					<?php $ttl = "We're Ready to Pay Top Dollar for Your Old Photo & Video Gear! Get a Quote Today!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/TradeProgram/p_1.php"); ?>					
