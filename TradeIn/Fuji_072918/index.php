		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_FujiTrade_072918"; ?>
					
					<?php $ttl = "Plus, up to 70% off when you trade in used equipment!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/Fuji_072918/p_1.php"); ?>			
					<?php include_once("TradeIn/Fuji_072918/p_2.php"); ?>	
          <?php include_once("TradeIn/Fuji_072918/p_3.php"); ?>	
