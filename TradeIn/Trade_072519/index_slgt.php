		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Trade_072519"; ?>
					
					<?php $ttl = "Trade-in your old gear now for up to 70% cash back"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/Trade_072519/p_1.php"); ?>
          <?php include_once("TradeIn/Trade_072519/devider.php"); ?>
          <?php include_once("TradeIn/Trade_072519/p_2.php"); ?>		
