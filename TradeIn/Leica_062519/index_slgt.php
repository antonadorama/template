		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Trade_062519"; ?>
					
					<?php $ttl = "Get up to 70% cash back for your old gear"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/Leica_062519/p_1.php"); ?>
          <?php include_once("TradeIn/Leica_062519/p_2.php"); ?>
          <?php include_once("TradeIn/Leica_062519/p_3.php"); ?>
