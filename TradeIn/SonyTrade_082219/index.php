...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_SonyTrade_082219"; ?>
					
					<?php $ttl = "Earn up to 70% cashback for your old gear || Trade in & trade up!"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>             

          <?php include_once("TradeIn/SonyTrade_082219/p_1.php"); ?>
          <?php include_once("TradeIn/SonyTrade_082219/p_2.php"); ?>
          <?php include_once("TradeIn/SonyTrade_082219/p_3.php"); ?>
