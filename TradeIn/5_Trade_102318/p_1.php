              ...
              <tbody>
                <tr>
                  <td align="center" valign="top">
                    <a href="hhttps://www.adorama.com/bmccp4k.html?emailprice=t&utm_source=slgt&email=##email_address##&utm_medium=email&guid=##GUID##&utm_content=Body&utm_campaign=<?php echo $utm;?>" target="_blank" 
                       linkname="BlackmagicDesignPocketCinema">
                    <img src="image_library/org_1/4452/eMail-Trade-BlackMagic_Pocket4K-1.jpg" style="border: 0px;border-radius: 0px;display: block;max-width: 640px;width: 100%;height: auto;" class="mobile-full" 
                         alt="Blackmagic Design Pocket Cinema" hspace="0" border="0" vspace="0" width="640">
                    </a>
                  </td>
                </tr>
              </tbody>
