		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Trade_Fuji_102318"; ?>
					
					<?php $ttl = "Click now to see your trade-in value!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>
					

					<?php //include_once("TradeIn/5_Trade_102318/p_1.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_2.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_1_eos.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_2_eos.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_1_xf.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_2_xf.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_1_nikon.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_2_nikon.php"); ?>
          <?php include_once("TradeIn/5_Trade_102318/p_1_fuji.php"); ?>
          <?php include_once("TradeIn/5_Trade_102318/p_2_fuji.php"); ?>
          
          
          <?php //include_once("TradeIn/5_Trade_102318/p_3_blackmagic.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_3_canon.php"); ?>
          <?php //include_once("TradeIn/5_Trade_102318/p_3_nikon.php"); ?>
          <?php include_once("TradeIn/5_Trade_102318/p_3_fuji.php"); ?>
