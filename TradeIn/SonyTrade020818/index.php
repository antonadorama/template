		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_SonyTrade_020918"; ?>
					
					<?php $ttl = "Catch this SONY trade up event now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>

											
					<?php include_once("TradeIn/SonyTrade020818/p_1.php"); ?>
					<?php include_once("TradeIn/SonyTrade020818/p_2.php"); ?>
					<?php include_once("TradeIn/SonyTrade020818/p_3.php"); ?>							
