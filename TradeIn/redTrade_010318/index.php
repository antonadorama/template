		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_RedTrade_010319"; ?>
					
					<?php $ttl = "It's time to trade up now!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/redTrade_010318/p_1.php"); ?>			
					<?php include_once("TradeIn/redTrade_010318/p_2.php"); ?>				
