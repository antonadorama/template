...
<table bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="iosfix">
	<tbody>
		<tr>
          ...
          <?php $utm = "Email_Trade_091219"; ?>
					
					<?php $ttl = "End your summer with extra cash! Trade-in your old gear today"; ?>
					
					<?php include_once("Other/blocks/header_slth.php"); ?>             

          <?php include_once("TradeIn/Trade_091219/p_1.php"); ?>
          <?php include_once("TradeIn/Trade_091219/devider.php"); ?>
          <?php include_once("TradeIn/Trade_091219/p_2.php"); ?>
