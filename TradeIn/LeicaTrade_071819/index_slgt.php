		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_LeicaTrade_071819"; ?>
					
					<?php $ttl = "Trade on your old Leica gear to put towards your new camera >>"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/LeicaTrade_071819/p_1.php"); ?>

          <?php include_once("TradeIn/LeicaTrade_071819/p_2.php"); ?>
          
          <?php include_once("TradeIn/LeicaTrade_071819/p_3.php"); ?>
