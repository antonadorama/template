		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_SigmaTrade_011719"; ?>
					
					<?php $ttl = "Trade in your Sigma lenses for new gear. Contact us now and trade up!"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/TradeSigma/p_1.php"); ?>
          <?php include_once("TradeIn/TradeSigma/p_2.php"); ?>	

          <?php include_once("TradeIn/TradeSigma/p_4.php"); ?>			
