		...
		<tr>
			...
			<table align="center" bgcolor="#e3e3e3" border="0" cellpadding="0" cellspacing="0" class="wrap640" width="640">
				<tbody>
					...
					<?php $utm = "Email_Trade_061819"; ?>
					
					<?php $ttl = "Trade in your old gear for CASH! Get a quote today"; ?>
					
					<?php include_once("Other/blocks/header.php"); ?>					

					<?php include_once("TradeIn/Trade_061819/p_1.php"); ?>
          <?php include_once("Other/PostHolidayTemplate/devider.php"); ?>
          <?php include_once("TradeIn/Trade_061819/p_2.php"); ?>		
